...
public class DocumentoVersPrsr {
    ...
    // §§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§
    public void parseDocumentoGen(DocumentoVers documento, ECDocumentoType esitoDoc, AbsVersamentoExt versamento,
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            this.verificaTipoStruttura(documento, esitoDoc, versamento, rispostaWs, rispostaControlli);
        }
    ...
    private void verificaTipoDoc(DocumentoVers documento, ECDocumentoType esitoDoc, AbsVersamentoExt versamento,
    ...
    private void parseDatiFisc(DocumentoVers documento, ECDocumentoType esitoDoc, IRispostaWS rispostaWs,
    ...
    private void verificaTipoStruttura(DocumentoVers documento, ECDocumentoType esitoDoc, AbsVersamentoExt versamento,
            IRispostaWS rispostaWs, RispostaControlli rispostaControlli) {
        rispostaControlli.reset();
    ...
    private void verificaComponenti(DocumentoVers documento, ECDocumentoType esitoDoc, AbsVersamentoExt versamento,
            IRispostaWS rispostaWs, RispostaControlli rispostaControlli) {
        ...
        for (ComponenteVers valueCompVers : documento.getFileAttesi()) {
            if (rispostaWs.getSeverity() != SeverityEnum.ERROR && valueCompVers.getMySottoComponente() == null) {
                 ...
                 */
                if ((rispostaWs.getSeverity() != SeverityEnum.ERROR)) {
                    this.verificaSottoComponentiComp(valueCompVers, documento, esitoDoc, versamento, rispostaWs,
                            rispostaControlli, ordiniDiPresentazioneUnici);
                }
            }
    ...
    private void verificaSottoComponentiComp(ComponenteVers componentePadre, DocumentoVers documento,
            ECDocumentoType esitoDoc, AbsVersamentoExt versamento, IRispostaWS rispostaWs,
            RispostaControlli rispostaControlli, Set<Long> ordiniDiPresentazioneUnici) {
        ...
        if (componentePadre.getMyComponente().getSottoComponenti() != null) {
            ...
            for (ComponenteVers valueCompVers : documento.getFileAttesi()) {
                if (rispostaWs.getSeverity() != SeverityEnum.ERROR && valueCompVers.getMySottoComponente() != null
                    ...
                    // verifico gli eventuali dati specifici e di migrazione
                    if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
                        this.parseDatiSpecSottoComp(valueCompVers, sottoComponenteResp, versamento, rispostaWs);
                    }
    ...
    private void parseDatiSpecDoc(DocumentoVers documento, ECDocumentoType esitoDoc, AbsVersamentoExt versamento,
            IRispostaWS rispostaWs) {
    ...
    private void parseDatiSpecComp(ComponenteVers componente, ECComponenteType esitoComp, AbsVersamentoExt versamento,
            IRispostaWS rispostaWs) {
        JAXBElement<DatiSpecificiType> tmpDatiSpecifici;
        JAXBElement<DatiSpecificiType> tmpDatiSpecificiMigrazione;
        RispostaControlliAttSpec tmpControlliAttSpec = null;
        ...
        if (versamento.getModificatoriWSCalc().contains(ModificatoriWS.TAG_DATISPEC_EXT)) {
            ...
            tmpControlliAttSpec = gestioneDatiSpec.parseDatiSpec(TipiEntitaSacer.COMP, tmpDatiSpecifici,
    ...
    private void parseDatiSpecSottoComp(ComponenteVers componente, ECSottoComponenteType esitoComp,
        ...
        if (versamento.getModificatoriWSCalc().contains(ModificatoriWS.TAG_DATISPEC_EXT)) {
            ...
            tmpControlliAttSpec = gestioneDatiSpec.parseDatiSpec(TipiEntitaSacer.SUB_COMP, tmpDatiSpecifici,
                    componente.getIdTipoComponente(), componente.getChiaveComp(),
