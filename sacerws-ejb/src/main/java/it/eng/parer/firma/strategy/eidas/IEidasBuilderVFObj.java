...
public interface IEidasBuilderVFObj<T extends Object> {
    ...
    /**
     * Main method per la generazione del dto trattatot nel singolo strategy (vedi
     * {@link EidasFirmaBuilder} {@link EidasMarcaBuilder}), viene restituito un oggetto di tipo
     * {@link VFFirmaCompType} / {@link VFMarcaCompType}
     *
     * @param eidasReportsDto   dto contentenete la risposta del servizio di verifica firma EIDAS
     * @param vfWrapper         wrapper finale che conterrà i report EIDAS mappati opportunamente
     * @param signatureW        wrapper firma EIDAS
     * @param timestampW        timestamp wrapper EIDAS
     * @param dataDiRiferimento data di verifica (esplicitata su metadati o sysdate)
     * @param pgs               array di progressivi busta/firma/marca
     *
     * @return restituitisce un oggetto di tipo {@link VFFirmaCompType} o {@link VFMarcaCompType}
     *
     * @throws InvocationTargetException eccezione generica
     * @throws IllegalArgumentException  eccezione generica
     * @throws IllegalAccessException    eccezione generica
