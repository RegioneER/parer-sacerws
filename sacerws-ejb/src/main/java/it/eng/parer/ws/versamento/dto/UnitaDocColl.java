...
public class UnitaDocColl implements Serializable {
    ...
    /*
     * questa variabile contiene l'insieme in ordine di inserimento di tutte le descrizioni dei
     * collegamenti che puntano ad una stessa ud. dal momento che l'implementazione di LinkedHashSet
     * è un set, le descrizioni duplicate vengono automaticamente ignorate
     */
