...
public class GestioneDatiSpec {
    ...
    public RispostaControlliAttSpec parseDatiSpec(TipiEntitaSacer tipoEntita,
            ...
            String desElemento, String desTipoElemento, String sistemaMig, long idOrgStrutt,
        ...
        if (datiSpecificiElement == null || datiSpecificiElement.isNil()) {
            // verifica che esistano dati specifici attesi per idTipoEntita + tipoentita alla data
            // corrente
            RispostaControlli rispostaControlli = controlliSemantici.checkPresenzaDatiSpec(
                    TipiUsoDatiSpec.VERS, tipoEntita, sistemaMig, idOrgStrutt, idTipoElemento,
                    tmpIstanteCorrente);
            ...
            if (rispostaControlli.isrBoolean()) {
                ...
                this.setRispostaError(MessaggiWSBundle.DATISPEC_001_002,
                        MessaggiWSBundle.getString(MessaggiWSBundle.DATISPEC_001_002,
            ...
            // NOTA: questo errore non può essere mai restituito perché il tag VersioneDatiSpecifici
            // è definito
            ...
            if (rispostaControlli.getrString() == null
                ...
                // errore, perché non ha trovato il validatore dei dati specifici per il tipo doc e
                // versione indicato
                ...
                if (rc.getCodErr() != null) {
                    this.setRispostaError(rc.getCodErr(), rc.getDsErr(), rispostaWs,
                ...
                if (rc.isrBoolean()) {
                    ...
                    this.setRispostaError(MessaggiWSBundle.DATISPEC_001_004,
                            MessaggiWSBundle.getString(MessaggiWSBundle.DATISPEC_001_004,
                    ...
                    this.setRispostaError(MessaggiWSBundle.DATISPEC_001_001,
                            MessaggiWSBundle.getString(MessaggiWSBundle.DATISPEC_001_001,
                                    tipoEntita.descrivi(), desElemento, versione, desTipoElemento),
                            rispostaWs, rispostaControlliAttSpec);
                }
                return rispostaControlliAttSpec;
            ...
            try {
                ...
                java.util.logging.Logger.getLogger(GestioneDatiSpec.class.getName())
            ...
            try {
                ...
                this.setRispostaError(MessaggiWSBundle.ERR_666, MessaggiWSBundle.getString(
                        MessaggiWSBundle.ERR_666,
                        "GestioneDatiSpec.parseDatiSpec.il validatore xsd specifico è errato: "
                                + e.getMessage()),
                        rispostaWs, rispostaControlliAttSpec);
            ...
            try {
                ...
                // Errore nella verifica dei dati specifici.
                this.setRispostaError(MessaggiWSBundle.DATISPEC_003_001,
                        MessaggiWSBundle.getString(MessaggiWSBundle.DATISPEC_003_001,
                ...
                this.setRispostaError(MessaggiWSBundle.ERR_666, MessaggiWSBundle.getString(
                        MessaggiWSBundle.ERR_666,
                        "GestioneDatiSpec.parseDatiSpec.problemi nella validazione dei dati spec: "
                                + e.getMessage()),
                        rispostaWs, rispostaControlliAttSpec);
                log.error("Errore interno: problemi nella validazione dei dati spec. Eccezione: ",
                        e);
                return rispostaControlliAttSpec;
            }

            // leggi la tabella dei dati spec attesi
            rispostaControlliAttSpec = controlliSemantici.checkDatiSpecifici(TipiUsoDatiSpec.VERS,
                    tipoEntita, sistemaMig, idOrgStrutt, idTipoElemento, tmpIdVersioneXsd);
            if (rispostaControlliAttSpec.getCodErr() != null) {
                this.setRispostaError(rispostaControlliAttSpec.getCodErr(),
                        rispostaControlliAttSpec.getDsErr(), rispostaWs, rispostaControlliAttSpec);
                return rispostaControlliAttSpec;
            }
            ...
            for (Element element : datiSpecifici.getAny()) {
                if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
                    ...
                    if (tmpAttSpecAtteso != null) {
                         ...
                         * "non coincidono con l'XSD "), rispostaWs, rispostaControlliAttSpec);
                         */
                        log.error(
    ...
    public RispostaControlliAttSpec parseDatiSpecMig(TipiEntitaSacer tipoEntita,
            JAXBElement<DatiSpecificiType> datiSpecificiElement, String desElemento,
        ...
        if (datiSpecificiElement == null || datiSpecificiElement.isNil()) {
            if (tmpSistMigDef) {
                // verifica che esistano dati specifici attesi per sistema migrante + tipoentita
                // alla data corrente
                RispostaControlli rispostaControlli = controlliSemantici.checkPresenzaDatiSpec(
                        TipiUsoDatiSpec.MIGRAZ, tipoEntita, sistemaMig, idOrgStrutt, 0,
                        tmpIstanteCorrente);
                if (rispostaControlli.getCodErr() != null) {
                    this.setRispostaError(rispostaControlli.getCodErr(),
                            rispostaControlli.getDsErr(), rispostaWs, rispostaControlliAttSpec);
                    return rispostaControlliAttSpec;
                }
                if (rispostaControlli.isrBoolean()) {
                    // errore, perché non ha inserito il tag datispecifici e questo era richiesto
                    this.setRispostaError(MessaggiWSBundle.DATISPECM_001_002,
                            MessaggiWSBundle.getString(MessaggiWSBundle.DATISPECM_001_002,
                                    tipoEntita.descrivi(), desElemento, desTipoElemento),
                            rispostaWs, rispostaControlliAttSpec);
                    return rispostaControlliAttSpec;
                }
            ...
            if (tmpSistMigDef) {
                ...
                if (rispostaControlli.getrString() == null
                    ...
                    if (rc.isrBoolean()) {
                        ...
                        this.setRispostaError(MessaggiWSBundle.DATISPECM_001_004,
                                MessaggiWSBundle.getString(MessaggiWSBundle.DATISPEC_001_004,
                                        tipoEntita.descrivi(), desElemento, versione,
                                        desTipoElemento),
                                rispostaWs, rispostaControlliAttSpec);
                    } else {
                        // Errore nella verifica dei dati specifici.
                        ...
                        this.setRispostaError(MessaggiWSBundle.DATISPECM_001_001,
                                MessaggiWSBundle.getString(MessaggiWSBundle.DATISPECM_001_001,
                                        tipoEntita.descrivi(), desElemento, versione,
                                        desTipoElemento),
                                rispostaWs, rispostaControlliAttSpec);
                    }
                ...
                try {
                    ...
                    this.setRispostaError(MessaggiWSBundle.DATISPECM_003_001,
                            MessaggiWSBundle.getString(MessaggiWSBundle.DATISPECM_003_001,
                                    tipoEntita.descrivi(), desElemento, events.getMessage()),
                            rispostaWs, rispostaControlliAttSpec);
                    return rispostaControlliAttSpec;
                } catch (Exception e) {
                ...
                if (rispostaControlliAttSpec.getCodErr() != null) {
                    this.setRispostaError(rispostaControlliAttSpec.getCodErr(),
                            rispostaControlliAttSpec.getDsErr(), rispostaWs,
                            rispostaControlliAttSpec);
                    return rispostaControlliAttSpec;
                }
                ...
                for (Element element : datiSpecifici.getAny()) {
                    if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
                        ...
                        tmpAttSpecAtteso = rispostaControlliAttSpec.getDatiSpecifici()
                                .get(tmpChiave);
                        if (tmpAttSpecAtteso != null) {
                            if (tmpAttSpecAtteso.getValore() == null) {
                                if (element.getFirstChild() != null) {
                                    ...
                                    if (tmpValore.length() <= MAXLEN_DATOSPEC) {
                                        ...
                                        this.setRispostaError(MessaggiWSBundle.DATISPECM_002_001,
                                                MessaggiWSBundle.getString(
                                                        ...
                                                        tipoEntita.descrivi(), desElemento,
                                                        tmpChiave, MAXLEN_DATOSPEC),
                                                rispostaWs, rispostaControlliAttSpec);
                                        return rispostaControlliAttSpec;
                                    }
                                } else {
                                ...
                                this.setRispostaError(MessaggiWSBundle.DATISPECM_002_002,
                                        MessaggiWSBundle.getString(
                                                MessaggiWSBundle.DATISPECM_002_002,
                                                tipoEntita.descrivi(), desElemento, tmpChiave),
                                        rispostaWs, rispostaControlliAttSpec);
                                return rispostaControlliAttSpec;
                            }
                ...
                /*
                 * nota questo è un problema, perché questo controllo deve essere già stato fatto
                 * nella classe VerificaVersione
                 */
                this.setRispostaError(MessaggiWSBundle.ERR_666, MessaggiWSBundle.getString(
                        MessaggiWSBundle.ERR_666,
