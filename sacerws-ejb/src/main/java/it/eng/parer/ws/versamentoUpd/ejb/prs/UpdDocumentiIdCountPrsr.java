...
public class UpdDocumentiIdCountPrsr extends UpdBasePrsr {
    ...
    public boolean eseguiControlli(UpdVersamentoExt versamento) {
        ...
        AggiornamentoUnitaDocumentariaType aggiornamentoUnitaDocumentaria = versamento.getVersamento()
        ...
        if (aggiornamentoUnitaDocumentaria.getDocumentoPrincipale() != null) {
            progressivo = 1;
            boolean result = this.aggiungiVerificaDocumento(aggiornamentoUnitaDocumentaria.getDocumentoPrincipale(),
                    progressivo, CategoriaDocumento.Principale, tmpDocumentiMap, documentiAttesi, versamento,
        ...
        if (aggiornamentoUnitaDocumentaria.getAllegati() != null) {
            ...
            while (tmpEnumDoc.hasNext()) {
                ...
                boolean result = this.aggiungiVerificaDocumento(tmpDocumentoType, progressivo,
                        CategoriaDocumento.Allegato, tmpDocumentiMap, documentiAttesi, versamento, componentiAttesi,
        ...
        if (aggiornamentoUnitaDocumentaria.getAnnessi() != null) {
            ...
            while (tmpEnumDoc.hasNext()) {
                ...
                contaAnnessi += 1;
                boolean result = this.aggiungiVerificaDocumento(tmpDocumentoType, progressivo,
                        CategoriaDocumento.Annesso, tmpDocumentiMap, documentiAttesi, versamento, componentiAttesi,
                        sottoComponentiAttesi);
                if (result) {
                    trovatiIdDocDuplicati = true;
                }
        ...
        if (aggiornamentoUnitaDocumentaria.getAnnotazioni() != null) {
            ...
            while (tmpEnumDoc.hasNext()) {
                ...
                contaAnnotazioni += 1;
                boolean result = this.aggiungiVerificaDocumento(tmpDocumentoType, progressivo,
                        CategoriaDocumento.Annotazione, tmpDocumentiMap, documentiAttesi, versamento, componentiAttesi,
                        sottoComponentiAttesi);
                if (result) {
                    trovatiIdDocDuplicati = true;
                }
    ...
    private boolean aggiungiVerificaDocumento(DocumentoType doc, int progressivo, CategoriaDocumento categoria,
            ...
            UpdVersamentoExt versamento, HashMap<String, UpdComponenteVers> componentiAttesi,
        ...
        if (doc.getStrutturaOriginale() != null && doc.getStrutturaOriginale().getComponenti() != null) {
            this.verificaComponenti(tmpDocumentoVers, versamento, componentiAttesi, sottoComponentiAttesi);
        }
    ...
    private void verificaComponenti(UpdDocumentoVers documentoVersato, UpdVersamentoExt versamento,
        ...
        while (tmpEnumCompo.hasNext()) {
            ...
            tmpComponenteVers.setTipoSupporto(tmpComponente.getTipoSupportoComponente() != null
                    ? ComponenteVers.TipiSupporto.valueOf(tmpComponente.getTipoSupportoComponente().value()) : null);
