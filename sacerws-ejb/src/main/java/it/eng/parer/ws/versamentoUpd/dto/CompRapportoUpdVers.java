...
public class CompRapportoUpdVers {
    ...
    public ParametriAggiornamentoType getParametriAggiornamento() {
        if (rapportoOk.getParametriAggiornamento() == null || rapportoKo.getParametriAggiornamento() == null) {
    ...
    /*
     * Nota: i documenti collegati restituiti fanno riferimento ad una UNICA istanza di DocumentoCollegatoType quindi
     * alla prima chiamata questa viene istanziata e poi si chiama SEMPRE la stessa istanza (indipendentemente dall'UD
     * che la chiama Questo vuol dire che è indifferente se da rapportoOk o da rapportoKo
     */
