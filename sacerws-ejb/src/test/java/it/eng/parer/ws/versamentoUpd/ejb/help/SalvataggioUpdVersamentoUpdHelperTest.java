...
public class SalvataggioUpdVersamentoUpdHelperTest {
    ...
    public static Archive<?> createTestArchive() {
        final JavaArchive sacerWSJavaArchive = createSacerWSJavaArchive(
                ...
                SalvataggioUpdVersamentoUpdHelper.class, SalvataggioUpdVersamentoUpdHelperTest.class,
                ...
                LogSessioneUpdVersamentoHelper.class, it.eng.parer.ws.ejb.ControlliSemantici.class,
        ...
        return createEnterpriseArchive(SalvataggioUpdVersamentoUpdHelperTest.class.getSimpleName(), sacerWSJavaArchive,
