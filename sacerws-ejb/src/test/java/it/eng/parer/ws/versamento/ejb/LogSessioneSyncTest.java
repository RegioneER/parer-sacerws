...
public class LogSessioneSyncTest {
    ...
    /*
     * @Test public void getVrsDocNonVers() { logSessioneSync.getVrsDocNonVers(0l, "tipoRegistro",
     * BigDecimal.ZERO, "numero", "idDocumento"); assertTrue(true); }
     *
     * @Test public void getVrsUnitaDocNonVers() { logSessioneSync.getVrsUnitaDocNonVers(0l,
     * "tipoRegistro", BigDecimal.ZERO, "numero"); assertTrue(true); }
     */
}
