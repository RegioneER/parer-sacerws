...
public class ObjectStorageConnection implements AutoCloseable {
     ...
     *            indirizzo dell'object storage scelto
     * @param accessKeyId
     *            access key id S3
     * @param secretKey
     *            secret key S3
     ...
     *
     * @param storageAddress
     *            indirizzo dell'object storage scelto (come URI)
     * @param accessKeyId
     *            access key id S3
     * @param secretKey
     *            secret key S3
    ...
    public ObjectStorageConnection(URI storageAddress, String accessKeyId, String secretKey) {
        ...
        log.info("Sto per effettuare il collegamento all'endpoint S3 [{}] dal thread {}", storageAddress,
