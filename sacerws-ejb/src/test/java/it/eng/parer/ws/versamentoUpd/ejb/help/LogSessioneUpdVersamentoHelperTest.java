...
public class LogSessioneUpdVersamentoHelperTest {
        ...
        return createEnterpriseArchive(LogSessioneUpdVersamentoHelperTest.class.getSimpleName(),
                createSacerWSJavaArchive(
                        Arrays.asList("it.eng.parer.ws.versamentoUpd.ext", "it.eng.parer.ws.xml.versUpdReq",
                                "it.eng.parer.ws.xml.versUpdResp"),
                        LogSessioneUpdVersamentoHelperTest.class, LogSessioneUpdVersamentoHelper.class,
                        it.eng.parer.ws.ejb.XmlUpdVersCache.class, it.eng.parer.util.ejb.AppServerInstance.class,
                        it.eng.parer.ws.ejb.ControlliSemantici.class,
                        it.eng.parer.util.ejb.help.ConfigurationHelper.class, it.eng.parerxml.xsd.FileXSD.class,
                        it.eng.parerxml.xsd.FileXSDUtil.class, it.eng.parer.util.DateUtilsConverter.class)
                                .addAsResource(
    ...
    public void recuperoUpdUnitaDocOk_queryIsOk() {
        ...
        final RispostaControlli rispostaControlli = helper.recuperoUpdUnitaDocOk(mockUpdVersamentoExt(), sessione);
        assertTrue(rispostaControlli.isrBoolean());
    }

    @Test
    public void cercaAggiornamentoKo_queryIsOk() {
        final RispostaControlli rispostaControlli = helper.cercaAggiornamentoKo(mockUpdVersamentoExt());
        assertTrue(rispostaControlli.isrBoolean());
    }

    @Test
    public void lockAndGetMonContaSesUpdUdKo_queryIsOk() {
        final RispostaControlli rispostaControlli = helper.lockAndGetMonContaSesUpdUdKo(mockVrsUpdUnitaDocKo());
        assertTrue(rispostaControlli.isrBoolean());
    }
    ...
    public void aggiornaConteggioMonContaSesUpdUdKo_queryIsOk() {
        ...
        for (it.eng.parer.entity.constraint.VrsSesUpdUnitaDocKo.TiStatoSesUpdKo tiStatoSesUpdKo : it.eng.parer.entity.constraint.VrsSesUpdUnitaDocKo.TiStatoSesUpdKo
            ...
            RispostaControlli rispostaControlli = helper.aggiornaConteggioMonContaSesUpdUdKo(vrsSesUpdUnitaDocKo,
                    monKeyTotalUdKo, false);
            assertTrue(rispostaControlli.isrBoolean());
