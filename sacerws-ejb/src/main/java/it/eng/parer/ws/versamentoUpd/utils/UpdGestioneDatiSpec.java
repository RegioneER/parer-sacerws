...
public class UpdGestioneDatiSpec {
    ...
    public RispostaControlliAttSpec parseDatiSpec(TipiEntitaSacer tipoEntita,
            ...
            String desElemento, String desTipoElemento) {
        ...
        try {
            ...
            log.error(
                    "Errore nel recupero dell'EJB dei controlli semantici in UpdGestioneDatiSpec ",
                    ex);
        ...
        try {
            xmlVersCache = (XmlUpdVersCache) new InitialContext()
                    .lookup("java:module/XmlUpdVersCache");
        } catch (NamingException ex) {
            rispostaControlliAttSpec.setCodErr(MessaggiWSBundle.ERR_666);
            rispostaControlliAttSpec.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.ERR_666,
        ...
        // alla data corrente
        rispostaControlli = controlliSemantici.checkPresenzaDatiSpec(TipiUsoDatiSpec.VERS,
                tipoEntita, this.sistemaDiMigrazione, this.idStruttura, idTipoElemento,
                tmpIstanteCorrente);
        if (datiSpecificiElement == null || datiSpecificiElement.isNil()) {
            ...
            if (this.modificatoriWS.contains(ModificatoriWS.TAG_DATISPEC_DEL_1_6)
                ...
                rispostaControlli = controlliSemantici.checkXSDDatiSpec(TipiUsoDatiSpec.VERS,
                        tipoEntita, this.sistemaDiMigrazione, this.idStruttura, idTipoElemento,
                ...
                if (rispostaControlli.getrString() == null
                    ...
                    RispostaControlli rc = controlliSemantici.checkPresenzaVersioneDatiSpec(
                            TipiUsoDatiSpec.VERS, tipoEntita, this.sistemaDiMigrazione,
                            this.idStruttura, idTipoElemento, versione);
                ...
                rispostaControlliAttSpec = controlliSemantici.checkDatiSpecifici(
                        TipiUsoDatiSpec.VERS, tipoEntita, this.sistemaDiMigrazione,
                        this.idStruttura, idTipoElemento, tmpIdVersioneXsd);
    ...
    public RispostaControlliAttSpec parseDatiSpecMig(TipiEntitaSacer tipoEntita,
        ...
        if (tmpSistMigDef) {
            ...
            if (this.modificatoriWS.contains(ModificatoriWS.TAG_DATISPEC_DEL_1_6)
                ...
                // verifica che esistano dati specifici attesi per idTipoEntita + tipoentita
                // alla data corrente
                rispostaControlli = controlliSemantici.checkPresenzaDatiSpec(TipiUsoDatiSpec.MIGRAZ,
                        tipoEntita, this.sistemaDiMigrazione, this.idStruttura, idTipoElemento,
                        tmpIstanteCorrente);
                if (rispostaControlli.getCodErr() != null)/* 666 */ {
                    // è un errore grave ...
                ...
                rispostaControlli = controlliSemantici.checkXSDDatiSpec(TipiUsoDatiSpec.MIGRAZ,
                        tipoEntita, this.sistemaDiMigrazione, this.idStruttura, 0,
                        tmpIstanteCorrente, versione);
                if (rispostaControlli.getCodErr() != null) {
                    rispostaControlliAttSpec.setCodErr(rispostaControlli.getCodErr());
                    rispostaControlliAttSpec.setDsErr(rispostaControlli.getDsErr());
                ...
                if (rispostaControlli.getrString() == null
                    ...
                    // cerco se per caso quella versione di dati spec esiste ma è disattivata
                    RispostaControlli rc = controlliSemantici.checkPresenzaVersioneDatiSpec(
                            TipiUsoDatiSpec.MIGRAZ, tipoEntita, this.sistemaDiMigrazione,
                            this.idStruttura, 0, versione);
                    if (rc.getCodErr() != null) {
                        rispostaControlliAttSpec.setCodErr(rispostaControlli.getCodErr());
                        rispostaControlliAttSpec.setDsErr(rispostaControlli.getDsErr());
                        rispostaControlliAttSpec.setrBoolean(false);
                ...
                rispostaControlliAttSpec = controlliSemantici.checkDatiSpecifici(
                        TipiUsoDatiSpec.MIGRAZ, tipoEntita, this.sistemaDiMigrazione,
                        this.idStruttura, 0, tmpIdVersioneXsd);
                if (rispostaControlliAttSpec.getCodErr() != null) {
                    rispostaControlliAttSpec.setrBoolean(false);
                    return rispostaControlliAttSpec;
                }
