...
### Novità: 3
- [#40330](https://parermine.regione.emilia-romagna.it/issues/40330) Aggiornamento versione libreria DSS 6.4
- [#40273](https://parermine.regione.emilia-romagna.it/issues/40273) Gestione dinamica della dimensione massima ammessa della somma degli attributi HEADER
- [#37233](https://parermine.regione.emilia-romagna.it/issues/37233) Gestione dei «lock» di aggiornamento UD oggetto di scarto

## 6.14.0 (03-03-2026)

### Novità: 1
- [#40019](https://parermine.regione.emilia-romagna.it/issues/40019) Patch di sicurezza per interventi legati a CVE

## 6.13.0 (06-02-2026)

### Bugfix: 1
- [#39785](https://parermine.regione.emilia-romagna.it/issues/39785) Correzione mancata gestione di errori generici nella validazione della risposa del servizio di verifica firma digitale eIDAS

### Novità: 1
- [#38893](https://parermine.regione.emilia-romagna.it/issues/38893) Aggiunta informazione ID_STRUT ai fini del partizionamento automatico delle tabelle delle sessioni di versamento andate a buon fine

## 6.12.1 (09-01-2026)

### Bugfix: 2
- [#39592](https://parermine.regione.emilia-romagna.it/issues/39592) Correzione dell'esito versamento versione 1.5
- [#39573](https://parermine.regione.emilia-romagna.it/issues/39573) Correzione nella gestione dei casi di errore con codice UD-002-001 (unità documentaria duplicata) e DOC-008-001 (documento già presente) e code refactor per abilitazione log conservazione 
