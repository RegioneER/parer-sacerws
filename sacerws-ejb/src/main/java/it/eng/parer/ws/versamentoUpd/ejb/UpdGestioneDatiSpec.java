...
public class UpdGestioneDatiSpec {
    ...
    public RispostaControlliAttSpec parseDatiSpec(TipiEntitaSacer tipoEntita,
            ...
            String desTipoElemento, String sistemaDiMigrazione, long idStruttura, boolean candelDatiSpec) {
        ...
        if (datiSpecificiElement == null || datiSpecificiElement.isNil()) {
            ...
            RispostaControlli rispostaControlli = controlliSemantici.checkPresenzaDatiSpec(TipiUsoDatiSpec.VERS,
                    tipoEntita, sistemaDiMigrazione, idStruttura, idTipoElemento, tmpIstanteCorrente);
            ...
            if (candelDatiSpec && (versione == null || versione.trim().isEmpty())) {
                ...
                if (rispostaControlliAttSpec.isrBoolean()) {
                    ...
                    rispostaControlliAttSpec.setIdRecXsdDatiSpec(rispostaControlliAttSpec.getrLong());
                    rispostaControlliAttSpec.setrBoolean(true);
                    return rispostaControlliAttSpec;
                }
            } else {
                RispostaControlli rispostaControlli = controlliSemantici.checkXSDDatiSpec(TipiUsoDatiSpec.VERS,
                        tipoEntita, sistemaDiMigrazione, idStruttura, idTipoElemento, tmpIstanteCorrente, versione);
                ...
                if (rispostaControlli.getrString() == null || rispostaControlli.getrString().length() == 0) {
                    ...
                    RispostaControlli rc = controlliSemantici.checkPresenzaVersioneDatiSpec(TipiUsoDatiSpec.VERS,
                            tipoEntita, sistemaDiMigrazione, idStruttura, idTipoElemento, versione);
                ...
                rispostaControlliAttSpec = controlliSemantici.checkDatiSpecifici(TipiUsoDatiSpec.VERS, tipoEntita,
                        sistemaDiMigrazione, idStruttura, idTipoElemento, tmpIdVersioneXsd);
        ...
        if (tmpSistMigDef) {
            ...
            if (candelDatiSpec && (versione == null || versione.trim().isEmpty())) {
                ...
                RispostaControlli rispostaControlli = controlliSemantici.checkXSDDatiSpec(TipiUsoDatiSpec.MIGRAZ,
                        tipoEntita, sistemaDiMigrazione, idStruttura, 0, tmpIstanteCorrente, versione);
                if (rispostaControlli.getCodErr() != null) {
                    rispostaControlliAttSpec.setCodErr(rispostaControlli.getCodErr());
                    rispostaControlliAttSpec.setDsErr(rispostaControlli.getDsErr());
                    rispostaControlliAttSpec.setrBoolean(false);
                ...
                if (rispostaControlli.getrString() == null || rispostaControlli.getrString().length() == 0) {
                    ...
                    RispostaControlli rc = controlliSemantici.checkPresenzaVersioneDatiSpec(TipiUsoDatiSpec.MIGRAZ,
                            tipoEntita, sistemaDiMigrazione, idStruttura, 0, versione);
                    if (rc.getCodErr() != null) {
                        rispostaControlliAttSpec.setCodErr(rispostaControlli.getCodErr());
                        rispostaControlliAttSpec.setDsErr(rispostaControlli.getDsErr());
                        rispostaControlliAttSpec.setrBoolean(false);
                ...
                rispostaControlliAttSpec = controlliSemantici.checkDatiSpecifici(TipiUsoDatiSpec.MIGRAZ, tipoEntita,
                        sistemaDiMigrazione, idStruttura, 0, tmpIdVersioneXsd);
                if (rispostaControlliAttSpec.getCodErr() != null) {
                    rispostaControlliAttSpec.setrBoolean(false);
                    return rispostaControlliAttSpec;
                }
