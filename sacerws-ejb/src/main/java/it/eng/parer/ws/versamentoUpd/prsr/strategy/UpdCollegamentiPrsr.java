...
public class UpdCollegamentiPrsr extends UpdBasePrsr {
    ...
    private static final Logger log = LoggerFactory.getLogger(UpdCollegamentiPrsr.class);
    ...
    public UpdCollegamentiPrsr(UpdVersamentoExt versamento, IRispostaUpdVersWS rispostaWs,
    ...
    private void init() {
        ...
        this.initControlliCollegamenti();
    ...
    private void initControlliCollegamenti() {
        // init NA
        for (AggiornamentoDocumentoCollegatoType.DocumentoCollegato documCollMd : versamento.getVersamento()
                .getUnitaDocumentaria().getDocumentiCollegati().getDocumentoCollegato()) {
            CSChiave tmpCsChiaveColl = new CSChiave();
            for (ControlloWSResp controllo : ControlliWSBundle
                    .getControlliByCdFamiglia(ControlloEseguito.FamigliaControllo.CONTROLLICOLLEGAMENTO.name())) {
                // CSChiave
    ...
    public boolean eseguiControlli() {
        ...
        Map<List<String>, UpdUnitaDocColl> tmpCollegamentiUd = new HashMap<List<String>, UpdUnitaDocColl>();
        ...
        try {
            ...
            this.setEsitoControlloErr(ControlliWSBundle.CTRL_GENERIC_ERROR, MessaggiWSBundle.ERR_666,
                    MessaggiWSBundle.getString(MessaggiWSBundle.ERR_666,
                            "UpdCollegamentiPrsr.init.ControlliSemantici: " + ex.getMessage()));
            log.error("Errore nel recupero dell'EJB dei controlli semantici in UpdCollegamentiPrsr ", ex);
            return false;
        }
        ...
        for (AggiornamentoDocumentoCollegatoType.DocumentoCollegato documCollMd : versamento.getVersamento()
            ...
            if (tmpUnitaDocColl == null) {
                ...
                rispostaControlli = controlliSemantici.checkChiave(tmpCsChiaveColl, strutturaUpdVers.getIdStruttura(),
                ...
                if (rispostaControlli.getrLong() == -1) { // se non ha trovato la chiave...
                    if (rispostaControlli.isrBoolean()) { // se in ogni caso la query è andata a buon fine
                        ...
                        versamento.addEsitoControlloOnControlliCollegamento(
                                ControlliWSBundle.getControllo(ControlliWSBundle.CTRL_COLL_ESISTEUDOCCOLLEGATA),
                ...
                if (faiVerificaFormaleChiave) {
                    ...
                    rispostaControlli = controlliSemantici.checkTipoRegistro(tmpCsChiaveColl.getTipoRegistro(),
                            descChiaveUdColl, strutturaUpdVers.getIdStruttura(), descChiaveUdColl);
                    ...
                    if (rispostaControlli.isrBoolean()) {
                        ...
                        // aggiunta su controlli su collegamento
                        versamento.addControlloOkOnControlliCollegamento(
                                ControlliWSBundle.getControllo(ControlliWSBundle.CTRL_COLL_REGUDCOLLEGATA),
                                tmpCsChiaveColl);
                    } else {
                    ...
                    rispostaControlli = controlliSemantici.caricaRegistroAnno(tmpCsChiaveColl.getTipoRegistro(),
                            strutturaUpdVers.getUrnPartChiaveUd(), tmpCsChiaveColl.getAnno(), tmpIdTipoRegistroUdColl,
                            descChiaveUdColl);
                    if (rispostaControlli.isrBoolean()) {
                    ...
                    KeySizeUtility tmpKeySizeUtility = new KeySizeUtility(strutturaUpdVers.getVersatoreNonverificato(),
                            tmpCsChiaveColl, null/* TPI: non utilizzato dato che si tratta solo di verificare */);
                ...
                if (tmpUnitaDocColl.generaDescrizione().length() > UnitaDocColl.MAX_LEN_DESCRIZIONE) {
                    ...
                    versamento.addEsitoControlloOnControlliCollegamentoBundle(
                            ControlliWSBundle.getControllo(ControlliWSBundle.CTRL_COLL_DESCR), rispostaWs.getSeverity(),
                            TipiEsitoErrore.NEGATIVO, tmpCsChiaveColl, MessaggiWSBundle.UD_004_006,
                            strutturaUpdVers.getUrnPartChiaveUd());
                    collegamentoHasErr = true;
                } else {
                    // registro esito positivo su controllo
                    // aggiunta su controlli su collegamento
                    versamento.addControlloOkOnControlliCollegamento(
                            ControlliWSBundle.getControllo(ControlliWSBundle.CTRL_COLL_DESCR), tmpCsChiaveColl);
                }
            }
        ...
        this.evaluateControlliOnCollegamenti(collegamentoHasErr, tmpForzaColl);
        ...
        if (collegamentoHasErr) {
            ...
            if (tmpForzaColl) {
                ...
                versamento.addEsitoControlloOnControlliUnitaDocumentariaBundle(
                        ControlliWSBundle.getControllo(ControlliWSBundle.CTRL_UD_COLLEGAMENTI),
                        rispostaWs.getSeverity(), TipiEsitoErrore.WARNING, MessaggiWSBundle.UD_016_003);
                ...
                versamento.addEsitoControlloOnControlliUnitaDocumentariaBundle(
                        ControlliWSBundle.getControllo(ControlliWSBundle.CTRL_UD_COLLEGAMENTI),
                        rispostaWs.getSeverity(), TipiEsitoErrore.NEGATIVO, MessaggiWSBundle.UD_016_003);
            }
