...
public class DocumentoVers implements java.io.Serializable, IDatiSpecEntity, IProfiloEntity {
    ...
    /**
     * @param rifDocumentoResp
     *            the rifDocumentoResp to set
     */
    ...
    /**
     * @param tiStatoDocDaElab
     *            the tiStatoDocDaElab to set
     */
    ...
    public Long getIdRecUsoXsdProfiloNormativo() {
        throw new NotImplementedException("getIdRecUsoXsdProfiloNormativo non implementato per il documento");
    }

    @Override
    public void setIdRecUsoXsdProfiloNormativo(Long idRecUsoXsdProfiloNormativo) {
        throw new NotImplementedException("setIdRecUsoXsdProfiloNormativo non implementato per il documento");
    }

    @Override
    public String getDatiC14NProfNormXml() {
        throw new NotImplementedException("getDatiC14NProfNormXml non implementato per il documento");
    }

    @Override
    public void setDatiC14NProfNormXml(String datiC14NProfNormXml) {
        throw new NotImplementedException("setDatiC14NProfNormXml non implementato per il documento");
    }
