...
public class ControlliPerFirme {
     ...
     *
     * @param idStrutVers identificativo della struttura versante
     *
     ...
     *
     * @param idDecFormatoFileStandard pk della tabella DEC_FORMATO_FILE_STANDARD
     *
     ...
     *
     * @param formato estensione standard del file
     *
     ...
     *
     * @param formatoVersato estensione dichiarata
     *
     ...
     *
     * @param tikaMime mime type del file sbustato
     *
     ...
     *
     * @param tiFormatoFirmaMarca lista di formati per filtrare
     *
     ...
     *
     * @param idFormatoFileDoc id formato documento
     * @param chiaveComp       chiave del componente
     * @param nmFormatoFileDoc nome formato file
     *
     ...
     *
     * @param idFormatoFileDoc chiave della DecFormatoFileDoc
     *
     ...
     *
     * @param dsSerialCertifCa   serial number
     * @param dlDnIssuerCertifCa distinguished name della CA
     *
     ...
     *
     * @param firCertifCa entity della CA
     * @param dsSerialCrl numero di serie della CRL (può essere null)
     * @param dtIniCrl    data inizio della CRL
     * @param dtScadCrl   data di scadenza della CRL
     *
     * @return null oppure l'identificativo dell'entity della CRL
     *
     * @throws it.eng.parer.firma.exception.VerificaFirmaException in caso di errore nell'accesso al
     *                                                             DB
     */
     ...
     *
     * @param firCertifCa              (id) della ca
     * @param dsSerialCertifFirmatario seriale del firmatario
     *
     ...
     *
     * @param dsSerialCertifFirmatario serial number del firmatario
     * @param firCertifCa              CA
     *
