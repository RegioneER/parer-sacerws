...
public final class VrsSessioneVersBuilder {
    ...
    public VrsSessioneVersBuilder vrsDatiSessioneVers(
	    List<VrsDatiSessioneVers> vrsDatiSessioneVers) {
	this.vrsDatiSessioneVers = vrsDatiSessioneVers;
	return this;
    }

    public VrsSessioneVersBuilder vrsDatiSessioneVersKo(
	    List<VrsDatiSessioneVersKo> vrsDatiSessioneVersKo) {
