...
public class SalvataggioCompFSTest {
    ...
    public static Archive<?> createTestArchive() {
        ...
        sacerWSJavaArchive.addAsResource(
                ArquillianTestUtils.class.getClassLoader().getResource("jboss-ejb3.xml"),
                "META-INF/jboss-ejb3.xml");
        return createEnterpriseArchive(SalvataggioCompFSTest.class.getSimpleName(),
    ...
    void verificaDirTPIDataViaDb_queryIsOk() {
        ...
        final RispostaControlli rispostaControlli = salvataggioCompFS
                .verificaDirTPIDataViaDb(versamento, new StatoCreaCartelle(), 1);
    ...
    void verificaDirTPIVersatoreViaDb_queryIsOk() {
        final RispostaControlli rispostaControlli = salvataggioCompFS.verificaDirTPIVersatoreViaDb(
                mockStrutturaVersamento(), new StatoCreaCartelle(), 1);
        assertTrue(rispostaControlli.isrBoolean());
    }
