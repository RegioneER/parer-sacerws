...
public class SalvataggioUpdVersamentoAroHelperTest {
    ...
    public static Archive<?> createTestArchive() {
        final JavaArchive sacerWSJavaArchive = createSacerWSJavaArchive(
                ...
                SalvataggioUpdVersamentoAroHelper.class, SalvataggioUpdVersamentoAroHelperTest.class,
        ...
        return createEnterpriseArchive(SalvataggioUpdVersamentoAroHelperTest.class.getSimpleName(), sacerWSJavaArchive,
