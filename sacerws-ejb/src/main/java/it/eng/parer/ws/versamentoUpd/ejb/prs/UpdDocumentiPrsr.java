...
public class UpdDocumentiPrsr extends UpdBasePrsr {
    ...
    private void initEsitoAndControlliDocumenti(UpdVersamentoExt versamento, CompRapportoUpdVers myEsito) {
        // init NA
    ...
    private void buildDocumentoOnResponse(UpdVersamentoExt versamento, CompRapportoUpdVers myEsito) {
        StrutturaUpdVers strutturaUpdVers = versamento.getStrutturaUpdVers();
    ...
    private void buildStrutturaOrigOnResponse(UpdDocumentoVers documento, UpdVersamentoExt versamento,
            CompRapportoUpdVers myEsito) {
    ...
    private boolean verificaIdDocumento(UpdDocumentoVers documento, UpdVersamentoExt versamento) {
        ...
        RispostaControlli rispostaControlli = updVersamentoControlli.checkIdDocumentoInUD(strutturaUpdVers.getIdUd(),
                documento.getRifUpdDocumento().getIDDocumento(), documento.getUrnPartDocumento());
    ...
    private boolean parseDatiSpecMigrazDoc(UpdDocumentoVers documento, UpdVersamentoExt versamento) {
        StrutturaUpdVers strutturaUpdVers = versamento.getStrutturaUpdVers();
    ...
    private boolean verificaOrdineComponente(UpdDocumentoVers documento, UpdVersamentoExt versamento) {
    ...
    private boolean verificaComponenti(UpdDocumentoVers documento, UpdVersamentoExt versamento) {
        ...
        for (UpdComponenteVers componente : documento.getUpdComponentiAttesi()) {
            ...
            if (prosegui) {
                prosegui = this.verificaTipoComponente(componente, componente.getKeyCtrl(), versamento);
            }

            // verifico nome componente
            if (prosegui) {
                prosegui = this.verificaNomeComponenti(componente, componente.getKeyCtrl(), versamento);
            }

            // verifico dati specifici
            if (prosegui && componente.getMyUpdComponente().getDatiSpecifici() != null) {
                prosegui = this.verificaDatiSpecComponente(componente, componente.getKeyCtrl(), versamento);
            }

            // verifico dati specifici migrazione
            if (prosegui && componente.getMyUpdComponente().getDatiSpecificiMigrazione() != null) {
                prosegui = this.verificaDatiSpecMigrazComponente(componente, componente.getKeyCtrl(), versamento);
            }
        }
    ...
    private boolean verificaIdComponente(UpdComponenteVers componente, String ctrlKey, UpdVersamentoExt versamento) {
        ...
        RispostaControlli rispostaControlli = updVersamentoControlli.checkIdComponenteInDoc(
                documento.getIdRecDocumentoDB(), componente.getMyUpdComponente().getOrdinePresentazione(),
    ...
    private boolean verificaTipoComponente(UpdComponenteVers componente, String ctrlKey, UpdVersamentoExt versamento) {
        UpdDocumentoVers documento = componente.getRifUpdDocumentoVers();
        boolean hasDocError = false;
        String codErr = null;
        String dsErr = null;
    ...
    private boolean verificaNomeComponenti(UpdComponenteVers componente, String ctrlKey, UpdVersamentoExt versamento) {
        UpdDocumentoVers documento = componente.getRifUpdDocumentoVers();
