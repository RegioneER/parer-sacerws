...
public final class VrsDatiSessioneVersBuilder {
    ...
    public VrsDatiSessioneVersBuilder vrsSessioneVersKo(
            Optional<VrsSessioneVersKo> vrsSessioneVersKo) {
        this.vrsSessioneVersKo = vrsSessioneVersKo;
        return this;
    }

    public VrsDatiSessioneVersBuilder vrsErrSessioneVers(
            List<VrsErrSessioneVers> vrsErrSessioneVers) {
        this.vrsErrSessioneVers = vrsErrSessioneVers;
        return this;
    }

    public VrsDatiSessioneVersBuilder vrsErrSessioneVersKo(
            List<VrsErrSessioneVersKo> vrsErrSessioneVersKo) {
    ...
    public VrsDatiSessioneVersBuilder vrsXmlDatiSessioneVers(
