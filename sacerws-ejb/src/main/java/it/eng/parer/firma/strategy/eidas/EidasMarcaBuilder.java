...
public class EidasMarcaBuilder extends EidasBaseWrapperResult implements IEidasBuilderVFObj<VFMarcaCompType> {
    ...
    public VFMarcaCompType build(EidasWSReportsDTOTree eidasReportsDto, VerificaFirmaWrapper vfWrapper,
        ...
        int urlIdx = 1;
        // check NON empty URL
        List<String> crlFiltered = xmlcertificateTsa.getCRLDistributionPoints().stream().filter(StringUtils::isNotBlank)
