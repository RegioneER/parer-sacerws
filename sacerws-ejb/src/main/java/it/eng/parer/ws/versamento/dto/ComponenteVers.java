...
public class ComponenteVers implements java.io.Serializable, IDatiSpecEntity, IProfiloEntity {
    ...
    public void setMySottoComponente(it.eng.parer.ws.xml.versReq.SottoComponenteType mySottoComponente) {
    ...
    public void setRifComponenteResp(it.eng.parer.ws.xml.versResp.ECComponenteType rifComponenteResp) {
    ...
    public void setRifSottoComponenteResp(it.eng.parer.ws.xml.versResp.ECSottoComponenteType rifSottoComponenteResp) {
    ...
    /**
     * Helper method per capire se sia necessario o meno effettuare il salvataggio delle buste crittografiche
     *
    ...
    public Long getIdRecUsoXsdProfiloNormativo() {
        throw new NotImplementedException("getIdRecUsoXsdProfiloNormativo non implementato per il componente");
    }

    @Override
    public void setIdRecUsoXsdProfiloNormativo(Long idRecUsoXsdProfiloNormativo) {
        throw new NotImplementedException("setIdRecUsoXsdProfiloNormativo non implementato per il componente");
    }

    @Override
    public String getDatiC14NProfNormXml() {
        throw new NotImplementedException("getDatiC14NProfNormXml non implementato per il componente");
    }

    @Override
    public void setDatiC14NProfNormXml(String datiC14NProfNormXml) {
        throw new NotImplementedException("setDatiC14NProfNormXml non implementato per il componente");
    }
