...
public class StrutturaVersamento implements java.io.Serializable, IDatiSpecEntity, IProfiloEntity {
    ...
    /**
     * @param documentiAttesi the documentiAttesi to set
     */
    ...
    /**
     * @param trovatiDuplicati the trovatiDuplicati to set
     */
    ...
    /**
     * @param trovatiIdDocDuplicati the trovatiIdDocDuplicati to set
     */
    ...
    /**
     * @param corrAllegatiDichiarati the corrAllegatiDichiarati to set
     */
    ...
    /**
     * @param corrAnnessiDichiarati the corrAnnessiDichiarati to set
     */
    ...
    /**
     * @param corrAnnotazioniDichiarati the corrAnnotazioniDichiarati to set
     */
    ...
    /**
     * @param idTipologiaUnitaDocumentaria the idTipologiaUnitaDocumentaria to set
     */
    ...
    public void setFlagAccettaConservazioneNonFirmatiNeg(
            boolean flagAccettaConservazioneNonFirmatiNeg) {
    ...
    /**
     * @param configFlagForzaControlloCrittografico the configFlagForzaControlloCrittografico to set
     */
    public void setConfigFlagForzaControlloCrittografico(
            boolean configFlagForzaControlloCrittografico) {
    ...
    /**
     * @param configFlagForzaControlloTrust the configFlagForzaControlloTrust to set
     */
    ...
    /**
     * @param configFlagForzaControlloCertificato the configFlagForzaControlloCertificato to set
     */
    public void setConfigFlagForzaControlloCertificato(
            boolean configFlagForzaControlloCertificato) {
    ...
    /**
     * @param configFlagForzaControlloNonConformita the configFlagForzaControlloNonConformita to set
     */
    public void setConfigFlagForzaControlloNonConformita(
            boolean configFlagForzaControlloNonConformita) {
    ...
    /**
     * @param configFlagForzaControlloRevoca the configFlagForzaControlloRevoca to set
     */
    ...
    /**
     * @param flagAccettaControlloOCSPNegativo the flagAccettaControlloOCSPNegativo to set
     */
    ...
    /**
     * @param flagAccettaControlloOCSPNoScaric the flagAccettaControlloOCSPNoScaric to set
     */
    ...
    /**
     * @param flagAccettaControlloOCSPNoValido the flagAccettaControlloOCSPNoValido to set
     */
    ...
    /**
     * @param flagAbilitaControlloRevoca the flagAbilitaControlloRevoca to set
     */
    ...
    /**
     * @param tiStatoUdDaElab the tiStatoUdDaElab to set
     */
