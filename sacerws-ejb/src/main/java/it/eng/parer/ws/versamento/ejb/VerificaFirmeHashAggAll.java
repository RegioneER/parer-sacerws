...
public class VerificaFirmeHashAggAll {
    ...
    public void controlloFirmeMarcheHash(VersamentoExtAggAll versamento, RispostaWSAggAll rispostaWs) {
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            RispostaControlli rispostaControlli = controlliPerFirme.getOrgStrutt(strutV.getIdStruttura());
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            ...
            if (!versamento.getStrutturaComponenti().effettuaVerificaFirma()) {
                ...
                if (versamento.getModificatoriWSCalc().contains(ModificatoriWS.TAG_FIRMA_1_5)) {
                    versamento.getStrutturaComponenti().setTiEsitoVerifFirme(SacerIndication.NON_ESEGUITO.name());
                    versamento.getStrutturaComponenti().setDsMsgEsitoVerifica(SacerIndication.NON_ESEGUITO.message());
                    //
