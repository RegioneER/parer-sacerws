...
public final class VrsXmlDatiSessioneVersBuilder {
    ...
    public VrsXmlDatiSessioneVersBuilder vrsDatiSessioneVers(
	    Optional<VrsDatiSessioneVers> vrsDatiSessioneVers) {
	this.vrsDatiSessioneVers = vrsDatiSessioneVers;
	return this;
    }

    public VrsXmlDatiSessioneVersBuilder vrsDatiSessioneVersKo(
	    Optional<VrsDatiSessioneVersKo> vrsDatiSessioneVersKo) {
	this.vrsDatiSessioneVersKo = vrsDatiSessioneVersKo;
	return this;
    }

    public VrsXmlDatiSessioneVersBuilder vrsUrnXmlSessioneVers(
	    List<VrsUrnXmlSessioneVers> vrsUrnXmlSessioneVers) {
