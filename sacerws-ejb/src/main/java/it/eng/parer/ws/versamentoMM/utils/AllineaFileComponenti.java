...
public class AllineaFileComponenti {
    ...
    public AllineaFileComponenti(VersamentoMMExt vers, RispostaWS risp, SyncFakeSessn sessione) {
        versamento = vers;
        rispostaWs = risp;
        sessioneFinta = sessione;
    }

    public void verificaCoerenza(String pathFileTemporanei) throws IOException {
