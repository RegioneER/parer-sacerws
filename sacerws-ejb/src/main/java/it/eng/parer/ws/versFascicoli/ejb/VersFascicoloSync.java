...
public class VersFascicoloSync {
    ...
    public void init(RispostaWSFascicolo rispostaWs, AvanzamentoWs avanzamento,
        ...
        if (!rs.isrBoolean()) {
            ...
            myEsitoComposito.getEsitoChiamataWS()
                    .setCredenzialiOperatore(ECEsitoPosNegType.POSITIVO);
    ...
    public void verificaVersione(String versione, RispostaWSFascicolo rispostaWs,
        ...
        if (!tmpRispostaControlli.isrBoolean()) {
            ...
            // se la versione è sbagliata o inesistente, tento comunque di produrre una sessione
            // fallita
    ...
    public void verificaCredenziali(String loginName, String password, String indirizzoIp,
        ...
        if (tmpRispostaControlli.isrBoolean()) {
            ...
            tmpRispostaControlli = myControlliWs.checkAuthWSNoOrg(tmpUser,
    ...
    public void salvaTutto(SyncFakeSessn sessione, RispostaWSFascicolo rispostaWs,
            VersFascicoloExt versamento) {
        ...
        if (!versamento.isSimulaScrittura() && rispostaWs
            ...
            if (rispostaWs.getSeverity() == IRispostaWS.SeverityEnum.ERROR) {
                ...
                if (rispostaWs
                    ...
                    myEsito.setErroriUlteriori(versamento.produciEsitoErroriSec());
                    myEsito.setWarningUlteriori(versamento.produciEsitoWarningSec());
                    if (!myLogSessioneFascicoli.registraSessioneFallita(rispostaWs, versamento,
                            sessione)) {
