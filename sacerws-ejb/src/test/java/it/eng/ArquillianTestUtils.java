...
public class ArquillianTestUtils {
    ...
    public static JavaArchive createSacerLogJavaArchive() {
        return ShrinkWrap.create(JavaArchive.class, "sacerlog.jar").addPackages(true, "it.eng.parer.sacerlog")
                .addAsResource(ArquillianTestUtils.class.getClassLoader().getResource("ejb-jar-sacerlog.xml"),
                        "META-INF/ejb-jar.xml")
                .addAsResource(
                        ArquillianTestUtils.class.getClassLoader().getResource("WSRequestIndiceSIPFascicolo_1.0.xsd"),
    ...
    public static JavaArchive createPaginatorJavaArchive() {
        return ShrinkWrap.create(JavaArchive.class, "paginator.jar")
                ...
                .addAsResource(ArquillianTestUtils.class.getClassLoader().getResource("ejb-jar-paginator.xml"),
                        "META-INF/ejb-jar.xml");
    }
    ...
    public static JavaArchive createSacerWSJavaArchive(List<String> packages, Class<?>... classes) {
        ...
        sacerWsJavaArchive
                .addPackages(true, "it.eng.parer.entity", "it.eng.parer.grantedEntity", "it.eng.parer.view_entity",
                        "it.eng.parer.util.ejb.help.dto", "it.eng.parer.ws.versamentoUpd.dto", "it.eng.parer.ws.dto",
                        "it.eng.parer.ws.versamento.dto", "org.apache.commons.lang3", "it.eng.parer.jboss.timer.common",
                        "it.eng.parer.crypto.model.exceptions", "it.eng.parer.eidas.model.exception",
                        "org.apache.commons.text", "com.fasterxml.uuid")
                .addPackages(false, "it.eng.parer.sacerlog.entity", "it.eng.parer.sacerlog.view_entity",
                        "it.eng.parer.exception", "it.eng.parer.ws.utils", "it.eng.parer.ws.versamentoUpd.utils",
                        "it.eng.sequences.hibernate")
                .addAsResource(ArquillianTestUtils.class.getClassLoader().getResource("persistence.xml"),
                        "META-INF/persistence.xml")
                .addAsResource(ArquillianTestUtils.class.getClassLoader().getResource("ejb-jar.xml"),
                        "META-INF/ejb-jar.xml")
                .addClass("it.eng.ArquillianTestUtils").addClass(it.eng.parer.util.ejb.help.ConfigurationHelper.class)
                .addClass(it.eng.spagoCore.util.UUIDMdcLogUtil.class)
                .addClass("org.springframework.http.client.ClientHttpRequestInterceptor")
                .addClass("org.springframework.retry.RetryCallback").addClass("org.springframework.http.HttpRequest")
