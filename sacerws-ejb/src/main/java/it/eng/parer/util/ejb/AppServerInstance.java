    ...
    protected void initSingleton() {
        try {
            ...
            if (!rispostaControlli.isrBoolean()) {
                LOG.error("Inizializzazione singleton AppServerInstance fallita! {}", rispostaControlli.getDsErr());
                throw new SacerWsRuntimeException(rispostaControlli.getDsErr(), SacerWsErrorCategory.INTERNAL_ERROR);
            } else {
            ...
            if (xmlDefaults.get(ParametroApplDB.SERVER_NAME_SYSTEM_PROPERTY) != null) {
                String instance = System.getProperty(xmlDefaults.get(ParametroApplDB.SERVER_NAME_SYSTEM_PROPERTY));
                if (instance != null) {
                    servername += "/" + instance;
                }
            }
