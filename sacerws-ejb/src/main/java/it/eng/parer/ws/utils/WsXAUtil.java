...
public class WsXAUtil {
    ...
    public static OutputStream createFileOS(XADiskBasicIOOperations session, File file,
            boolean createFile) throws SacerWsException {
        try {
            if (createFile) {
    ...
    public static boolean fileExistsAndIsDirectoryLockExclusive(XADiskBasicIOOperations session,
            File file) throws SacerWsException {
        try {
     ...
     *
     * @param session la sessione in transazione
     * @param dirPath la directory
     *
     * @throws SacerWsException errore generico
     */
