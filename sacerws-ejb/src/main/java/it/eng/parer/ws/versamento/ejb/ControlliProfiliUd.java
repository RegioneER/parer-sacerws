...
public class ControlliProfiliUd {
    ...
    public RispostaControlli checkProfiloNormativo(ProfiloNormativoType pfNormType,
            TipiEntitaSacer tiEntita, long idTiEntita, String descrEntita, String descrTiEntita) {
        //
    ...
    public List<Long> checkXsdProfileExistence(long idTiEntita, TipiEntitaSacer tiEntitaSacer,
        ...
        if (tiEntitaSacer.equals(TipiEntitaSacer.UNI_DOC)) {
            queryStr.append(
                    "select uso.idUsoModelloXsdUniDoc " + "from DecUsoModelloXsdUniDoc uso ");
        ...
        } else if (tiEntitaSacer.equals(TipiEntitaSacer.COMP)
                || tiEntitaSacer.equals(TipiEntitaSacer.SUB_COMP)) {
            queryStr.append(
                    "select uso.idUsoModelloXsdCompDoc " + "from DecUsoModelloXsdCompDoc uso ");
        ...
        queryStr.append("and uso.decModelloXsdUd.tiModelloXsd = :tiModelloXsdUd "
                ...
                + "and uso.dtIstituz <= :dataDiOggiIn " + "and uso.dtSoppres > :dataDiOggiIn ");
     ...
     */
    public Object[] getXsdProfileByVersion(List<Long> idUsoModelloXsds,
            TipiEntitaSacer tiEntitaSacer, TiModelloXsdUd tiModelloXsdUd, String version) {
        Object[] result = null;
