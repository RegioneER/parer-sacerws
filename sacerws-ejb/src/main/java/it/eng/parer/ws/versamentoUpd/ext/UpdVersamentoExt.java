...
public class UpdVersamentoExt extends AbsUpdVersamentoExt {
    ...
    private boolean hasDocumentiCollegatiToUpd = false;// NumeroAllegati, NumeroAnnessi,
						       // NumeroAnnotazioni
	...
	return this.hasDocumentoPrincipaleToUpd() || this.hasAnnessiToUpd()
		|| this.hasAnnotazioniToUpd() || this.hasAllegatiToUpd();
    }
     ...
     * (non-Javadoc)
     *
     * @see it.eng.parer.ws.versamentoUpd.dto.IControlliMultipli#produciControlliAllegato
     * (java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see it.eng.parer.ws.versamentoUpd.dto.IControlliMultipli#produciControlliAnnesso(
     * java.lang.String)
     */
    @Override
     ...
     * produciControlliAnnotazione(java.lang.String)
     */
    @Override
     ...
     *
     * @see it.eng.parer.ws.versamentoUpd.dto.IControlliMultipli#
     * produciControlliComponenteAllegati(java.lang.String)
     */
    @Override
     ...
     *
     * @see it.eng.parer.ws.versamentoUpd.dto.IControlliMultipli#
     * produciControlliComponenteAnnessi(java.lang.String)
     */
    @Override
     ...
     *
     * @see it.eng.parer.ws.versamentoUpd.dto.IControlliMultipli#
     * produciControlliDocPrincipale(java.lang.String)
     */
    @Override
     ...
     */
    @Override
    public ControlliFallitiUlterioriType produciControlliFallitiUlteriori(
	    RispostaWSUpdVers rispostaWs) {
	ControlliFallitiUlterioriType controlliFallitiUlterioriType = null;

	// clean first (in quanto sono dinamici ciò significa che ogni volta che vengono invocati
	// dovranno essere
     ...
     *
     * @see it.eng.parer.ws.versamentoUpd.dto.IControlliMultipli#
     * produciControlliUnitaDocumentaria()
     */
    @Override
    ...
    @Override
    public void addAggiornamentoDocumenti(AggiornamentoEffettuato aggiornamento,
    ...
    public void addAggiornamentoCompDocumenti(AggiornamentoEffettuato aggiornamento,
	    CategoriaDocumento catDoc, String key) {
	switch (catDoc) {
	case Principale:
