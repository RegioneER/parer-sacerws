...
public class SalvataggioFascicoli {
    ...
    public boolean salvaFascicolo(RispostaWSFascicolo rispostaWs, VersFascicoloExt versamento,
	...
	try {
	    ...
	    // salvo fascicolo
	    tmpRispostaControlli = salvataggioFascicoliHelper.scriviFascicolo(versamento, sessione,
		    tmpFascicoloKo);
	    if (!tmpRispostaControlli.isrBoolean()) {
		context.setRollbackOnly();
		this.impostaErrore(rispostaWs, versamento, tmpRispostaControlli);
	    ...
	    tmpRispostaControlli = salvataggioFascicoliHelper.scriviAmmPartecipanti(versamento,
		    tmpFasFascicolo);
	    if (!tmpRispostaControlli.isrBoolean()) {
		context.setRollbackOnly();
		this.impostaErrore(rispostaWs, versamento, tmpRispostaControlli);
	    ...
	    tmpRispostaControlli = salvataggioFascicoliHelper.scriviSoggCoinvolti(versamento,
		    tmpFasFascicolo);
	    if (!tmpRispostaControlli.isrBoolean()) {
		context.setRollbackOnly();
		this.impostaErrore(rispostaWs, versamento, tmpRispostaControlli);
	    ...
	    tmpRispostaControlli = salvataggioFascicoliHelper.scriviResponsabili(versamento,
		    tmpFasFascicolo);
	    if (!tmpRispostaControlli.isrBoolean()) {
		context.setRollbackOnly();
		this.impostaErrore(rispostaWs, versamento, tmpRispostaControlli);
	    ...
	    tmpRispostaControlli = salvataggioFascicoliHelper.scriviUoOrgResponsabili(versamento,
		    tmpFasFascicolo);
	    if (!tmpRispostaControlli.isrBoolean()) {
		context.setRollbackOnly();
		this.impostaErrore(rispostaWs, versamento, tmpRispostaControlli);
	    ...
	    tmpRispostaControlli = salvataggioFascicoliHelper.scriviRequestResponseFascicolo(
		    rispostaWs, versamento, sessione, tmpFasFascicolo);
	    if (!tmpRispostaControlli.isrBoolean()) {
		context.setRollbackOnly();
		this.impostaErrore(rispostaWs, versamento, tmpRispostaControlli);
		return false;
	    ...
	    tmpRispostaControlli = salvataggioFascicoliHelper.scriviProfiliXMLFascicolo(versamento,
	    ...
	    tmpRispostaControlli = salvataggioFascicoliHelper.scriviUnitaDocFascicolo(versamento,
		    tmpFasFascicolo);
	    if (!tmpRispostaControlli.isrBoolean()) {
		context.setRollbackOnly();
		this.impostaErrore(rispostaWs, versamento, tmpRispostaControlli);
	    ...
	    tmpRispostaControlli = salvataggioFascicoliHelper.scriviLinkFascicolo(versamento,
		    tmpFasFascicolo);
	    if (!tmpRispostaControlli.isrBoolean()) {
		context.setRollbackOnly();
		this.impostaErrore(rispostaWs, versamento, tmpRispostaControlli);
	    ...
	    // salvo warning
	    tmpRispostaControlli = salvataggioFascicoliHelper.scriviWarningFascicolo(versamento,
		    tmpFasFascicolo);
	    if (!tmpRispostaControlli.isrBoolean()) {
		context.setRollbackOnly();
		this.impostaErrore(rispostaWs, versamento, tmpRispostaControlli);
		...
		tmpRispostaControlli = salvataggioFascicoliHelper
			.salvaWarningAATipoFascicolo(versamento);
		if (!tmpRispostaControlli.isrBoolean()) {
		    context.setRollbackOnly();
		    this.impostaErrore(rispostaWs, versamento, tmpRispostaControlli);
		    return false;
	    ...
	    tmpRispostaControlli = elencoVersamentoFascicoli.scriviElvFascDaElabElenco(rispostaWs,
		    versamento, sessione, tmpFasFascicolo);
	    if (!tmpRispostaControlli.isrBoolean()) {
		context.setRollbackOnly();
		this.impostaErrore(rispostaWs, versamento, tmpRispostaControlli);
		return false;
	    ...
	    tmpRispostaControlli = elencoVersamentoFascicoli.scriviStatoConservFascicolo(rispostaWs,
		    versamento, sessione, tmpFasFascicolo);
	    if (!tmpRispostaControlli.isrBoolean()) {
		context.setRollbackOnly();
		this.impostaErrore(rispostaWs, versamento, tmpRispostaControlli);
	    ...
	    tmpRispostaControlli = elencoVersamentoFascicoli.scriviStatoFascicoloElenco(rispostaWs,
		    versamento, sessione, tmpFasFascicolo);
	    if (!tmpRispostaControlli.isrBoolean()) {
		context.setRollbackOnly();
		this.impostaErrore(rispostaWs, versamento, tmpRispostaControlli);
		...
		tmpRispostaControlli = salvataggioFascicoliHelper.ereditaVersamentiKoFascicolo(
			rispostaWs, versamento, sessione, tmpFasFascicolo, tmpFascicoloKo);
		if (!tmpRispostaControlli.isrBoolean()) {
		    context.setRollbackOnly();
		    this.impostaErrore(rispostaWs, versamento, tmpRispostaControlli);
		    return false;
	...
	versamento
		.aggiungErroreFatale(rispostaWs.getCompRapportoVersFascicolo().getEsitoGenerale());
    }
