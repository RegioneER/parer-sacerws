...
<html>
    <head>
        ...
        <title>Aggiunta Documenti Sincrona</title>
        <style>
            h1 {
    ...
    <body>
        <h1>Aggiunta Documenti Sincrona</h1>
        <h2>Viene chiamata la servlet/ws <b>AggiuntaAllegatiSync</b></h2>
        <form action="AggiuntaAllegatiSync" method="post"  enctype="multipart/form-data">
            <div class="box">
                <label>
                    <span>VERSIONE</span>
