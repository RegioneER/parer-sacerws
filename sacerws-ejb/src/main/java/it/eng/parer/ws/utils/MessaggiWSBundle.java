...
public class MessaggiWSBundle {
    ...
    /**
     * Fascicolo {0}: l''unità documentaria {1} indicata nel contenuto analitico non è presente in
     * Sacer o è stata annullata.
     */
    ...
    /**
     * Fascicolo {0}: il tipo fascicolo {1} non ha associato un xsd di profilo archivistico standard
    ...
    /**
     * Non sono definite partizioni DB per la sessione di versamento per la struttura {0} per la
     * data {1}
     */
    public static final String PART_003_002 = "PART-003-002";

    /**
     * Non sono definite partizioni DB per i componenti della sessione di versamento per la
     * struttura {0}
     */
    ...
    /**
     * Documento {0}: esiste più di un tipo di documento {1} attivo alla data corrente entro la
     * struttura versante. E’ necessario correggere la configurazione della struttura prima di
     * ripetere il versamento.
     */
    ...
    /**
     * Documento {0}: &lt;OrdinePresentazione&gt; del componente &lt;ID&gt;{1}&lt;/ID&gt; deve
     * essere maggiore di 0
     */
    public static final String DOC_007_002 = "DOC-007-002";

    /**
     * Documento {0}: &lt;OrdinePresentazione&gt;{1}&lt;/OrdinePresentazione&gt; del componente non
     * univoco
     */
    public static final String DOC_007_003 = "DOC-007-003";

    /**
     * Un documento con il tag &lt;IDDocumento&gt; uguale a {0} è già presente nell''Unità
     * Documentaria {1}
     */
    ...
    /**
     * Componente {0}: Il tipo di uso del tipo componente deve essere pari a "CONTENUTO" o a
     * "CONVERTITORE"
     */
    public static final String COMP_001_002 = "COMP-001-002";

    /**
     * Componente {0}: Il tag &lt;Riferimento&gt; non deve essere valorizzato se il tag
    ...
    /**
     * Componente {0}: Il tipo Rappresentazione Componente {1} indicato nel tag
     * &lt;TipoRappresentazioneComponente&gt; non è presente entro la struttura versante
     */
    public static final String COMP_003_001 = "COMP-003-001";

    /**
     * Componente {0}: Il tipo di output del Tipo Rappresentazione Componente {1} deve essere
     * configurato
     */
    public static final String COMP_003_002 = "COMP-003-002";

    /**
     * Componente {0}: Se è valorizzato il tag &lt;TipoRappresentazioneComponente&gt;, il tipo
     * supporto deve essere uguale a "FILE"
     */
    public static final String COMP_003_003 = "COMP-003-003";

    /**
     * Componente {0}: Se è valorizzato il tag &lt;TipoRappresentazioneComponente&gt;, l''unità
     * documentaria deve essere salvata su BLOB
     */
    public static final String COMP_003_004 = "COMP-003-004";

    /**
     * Componente {0}: Se è valorizzato il tag &lt;TipoRappresentazioneComponente&gt;, il tipo uso
     * componente deve essere uguale a "CONTENUTO"
     */
    ...
    /**
     * Componente {0}: Se è valorizzato Tipo Rappresentazione Componente deve essere presente uno ed
     * uno solo sottocomponente avente tipo uso CONVERTITORE o RAPPRESENTAZIONE
     */
    ...
    /**
     * Componente {0}: Il tag &lt;NomeComponente&gt; deve essere valorizzato (il componente ha un
    ...
    /**
     * Componente {0}: il numero di componenti del documento principale della UD di Riferimento {1}
     * non può essere maggiore di 1
     */
    public static final String COMP_008_001 = "COMP-008-001";

    /**
     * Componente {0}: il componente del documento principale della UD di Riferimento {1} è di tipo
     * diverso da "CONVERTITORE"
     */
    ...
    /**
     * Componente {0}: L''UD del convertitore indicato dal riferimento {1} deve essere salvata su
     * BLOB
     */
    public static final String COMP_008_004 = "COMP-008-004";

    /**
     * Componente {0}: Nel documento principale dell''UD indicata dal riferimento {1}, non sono
     * stati individuati componenti con tipo supporto uguale a "FILE"
     */
    ...
    /**
     * Componente {0}: se si valorizza l''ordine di presentazione è obbligatorio fornire
    ...
    /**
     * Componente {0}: file inesistente su filesystem.
     */
    public static final String COMP_011_001 = "COMP-011-001";
    ...
    /**
     * SottoComponente {0}: tag &lt;TipoSupportoComponente&gt; diverso da "FILE" e tipo uso uguale a
     * "CONVERTITORE"
     */
    public static final String SUBCOMP_002_005 = "SUBCOMP-002-005";

    /**
     * SottoComponente {0}: Il tag &lt;NomeComponente&gt; deve essere valorizzato (il componente ha
     * un tipo di supporto pari a "FILE")
     */
    public static final String SUBCOMP_003_001 = "SUBCOMP-003-001";

    /**
     * SottoComponente {0}: il Formato {1} non è ammesso per la struttura versante, il tipo
    ...
    /**
     * SottoComponente {0}: il numero di componenti del documento principale della UD di Riferimento
     * {1} non può essere maggiore di 1
     */
    public static final String SUBCOMP_006_001 = "SUBCOMP-006-001";

    /**
     * SottoComponente {0}: il componente del documento principale della UD di Riferimento {1} è di
     * tipo diverso da "CONVERTITORE"
     */
    ...
    /**
     * SottoComponente {0}: L''UD del convertitore indicato dal riferimento {1} deve essere salvata
     * su BLOB
     */
    public static final String SUBCOMP_006_004 = "SUBCOMP-006-004";

    /**
     * SottoComponente {0}: Nel documento principale dell''UD indicata dal riferimento {1}, non sono
     * stati individuati componenti con tipo supporto uguale a "FILE"
     */
    public static final String SUBCOMP_006_005 = "SUBCOMP-006-005";

    /**
     * SottoComponente {0}: il formato del componente del documento principale della UD di
     * Riferimento {1} non è ammesso per il Tipo Rappresentazione Componente
     */
    ...
    /**
     * {0} {1}: il tipo {0} {2} ha associato dei dati specifici. Il file XML deve pertanto includere
     * il tag &lt;DatiSpecifici&gt;
     */
    public static final String DATISPEC_001_002 = "DATISPEC-001-002";

    /**
     * {0} {1}: DEPRECATO il tipo {0} {2} ha associato dei dati specifici. Nel file XML occorre
    ...
    /**
     * {0} {1}: Errore nei dati specifici: il valore indicato nel tag {2} supera la lunghezza di {3}
     * caratteri
     */
    ...
    /**
     * {0} {1}: il tipo {0} {2} ha associato dei dati specifici di migrazione. Il file XML deve
     * pertanto includere il tag &lt;DatiSpecificiMigrazione&gt;
     */
    public static final String DATISPECM_001_002 = "DATISPECM-001-002";

    /**
     * {0} {1}: DEPRECATO il tipo {0} {2} ha associato dei dati specifici di migrazione. Nel file
     * XML occorre valorizzare il tag &lt;VersioneDatiSpecifici&gt;
     */
    ...
    /**
     * {0} {1}: Errore nei dati specifici di migrazione: il valore indicato nel tag {2} supera la
     * lunghezza di {3} caratteri
     */
    ...
    /**
     * {0} {1}: Esiste profilo normativo archivisitico associato a {2} ma non dichiarato su XML
     * versato
     */
    ...
    /**
     * {0} {1}: Esiste un xsd di profilo normativo associato a {2} attivo alla data di versamento.
     * Eliminazione non consentita per l''elemento ProfiloNormativo.
     */
    public static final String PROFNORM_001_005 = "PROFNORM-001-005";
    /**
     * {0} {1}: Profilo Normativo non presente nell''xml del SIP per l''Unità Documentaria.
     * Eliminazione non consentita per l''elemento ProfiloNormativo.
     */
    ...
    /**
     * Componente {0}: l''encoding usato per indicare l''hash non è supportato (sono gestiti Hex e
     * Base64)
     */
    public static final String HASH_002_001 = "HASH-002-001";

    /**
     * Componente {0}: l''algoritmo usato per indicare l''hash non è supportato (sono gestiti MD5,
     * SHA-1 e SHA-256, codificati in Hex e Base64)
     */
    public static final String HASH_003_001 = "HASH-003-001";

    /**
     * Componente {0}: l''hash calcolato non coincide con l''hash versato (l''encoding usato è {1},
     * l''algoritmo è {2})
     */
    ...
    /**
     * Controllare che i tag &lt;ID&gt; siano stati valorizzati correttamente. I valori devono
     * essere univoci entro l''indice Multimedia
     */
    public static final String MM_XSD_002_001 = "MM-XSD-002-001";

    /**
     * Componente Multimedia &lt;ID&gt; {0}: Tag &lt;ForzaFormato&gt; presente ma tag
     * &lt;VerificaFirmeFormati&gt; true
     */
    public static final String MM_COMP_001_001 = "MM-COMP-001-001";

    /**
     * Componente Multimedia &lt;ID&gt; {0}: Tag &lt;ForzaHash&gt; presente ma tag
     * &lt;CalcolaHash&gt; true
     */
     ...
     * SHA-1 in formato hexBinary)
     */
    public static final String MM_COMP_004_001 = "MM-COMP-004-001";

    /**
     * Componente Multimedia &lt;ID&gt; {0}: DEPRECATO Il tag &lt;URNFile&gt; obbligatorio e non
     * valorizzato
     */
    public static final String MM_COMP_005_001 = "MM-COMP-005-001";

    /**
     * Componente Multimedia &lt;ID&gt; {0}: Non è stato trovato un componente di versamento
     * corrispondente
     */
    ...
    /**
     * Componente di versamento &lt;ID&gt; {0}: Non è stato trovato un componente Multimedia
     * corrispondente
     */
    ...
    /**
     * l''Ambiente {0} è definito da caratteri non compresi nel set POSIX per i nomi di file: è
     * impossbile archiviare il documento sul filesystem
     */
    public static final String FILESYS_001_001 = "FILESYS-001-001";

    /**
     * l''Ente {0} è definito da caratteri non compresi nel set POSIX per i nomi di file: è
     * impossibile archiviare il documento sul filesystem
     */
    public static final String FILESYS_001_002 = "FILESYS-001-002";

    /**
     * la Struttura {0} è definita da caratteri non compresi nel set POSIX per i nomi di file: è
     * impossbile archiviare il documento sul filesystem
     */
    public static final String FILESYS_001_003 = "FILESYS-001-003";

    /**
     * il Registro {0} è definito da caratteri non compresi nel set POSIX per i nomi di file: è
     * impossbile archiviare il documento sul filesystem
     */
    public static final String FILESYS_001_004 = "FILESYS-001-004";

    /**
     * il Numero {0} è definito da caratteri non compresi nel set POSIX per i nomi di file: è
     * impossbile archiviare il documento sul filesystem
     */
    public static final String FILESYS_001_005 = "FILESYS-001-005";

    /**
     * il componente {0} non può essere archiviato su filesystem perchè il suo pathname supera i 254
     * caratteri
     */
    public static final String FILESYS_002_001 = "FILESYS-002-001";

    /**
     * il sottocomponente {0} non può essere archiviato su filesystem perchè il suo pathname supera
     * i 254 caratteri
     */
    public static final String FILESYS_002_002 = "FILESYS-002-002";

    /**
     * impossibile procedere con l''archiviazione su filesystem perché lo spazio su disco residuo è
     * prossimo all''esaurimento
     */
    public static final String FILESYS_003_001 = "FILESYS-003-001";

    /**
     * La richiesta di recupero dell''unità documentaria {0} è stata accettata. Il recupero dei file
     * è in corso
     */
    ...
    /**
     * L''utente ha già in corso il recupero di file dell''unità documentaria {0}: si deve aspettare
     * che tale recupero sia terminato
     */
    ...
    /**
     * Il recupero dei file dell''unità documentaria {0} è in corso da parte di un operatore
     * on-line; per il momento non è possibile richiedere il recupero dell''unità documentaria
     * mediante servizio web
     */
    public static final String SESREC_002_004 = "SESREC-002-004";

    /**
     * Il recupero dei file dell''unità documentaria {0} è in corso da parte del servizio di
     * recupero; per il momento non è possibile richiedere il recupero dell''unità documentaria
     * mediante download on-line
     */
    public static final String SESREC_002_005 = "SESREC-002-005";

    /**
     * Non sono stati individuati componenti il cui formato di rappresentazione sia compatibile con
     * il recupero DIP
     */
    public static final String RECDIP_001_001 = "RECDIP-001-001";

    /**
     * Il convertitore {0} del formato di rappresentazione {1}, relativo al componente {2}, risulta
     * marcato come ERRATO, impossibile procedere con la trasformazione
     */
    public static final String RECDIP_001_002 = "RECDIP-001-002";

    /**
     * Il formato di rappresentazione {0}, relativo al componente {1} con formato {2}, richiede un
     * file {3}, impossibile procedere con la trasformazione
     */
    public static final String RECDIP_001_003 = "RECDIP-001-003";

    /**
     * Il convertitore {0} del formato di rappresentazione {1}, relativo al componente {2}, ha reso
     * un errore di conversione ed è stato marcato come ERRATO: {3}
     */
    public static final String RECDIP_002_001 = "RECDIP-002-001";

    /**
     * Nessun modello di esibizione definito per la struttura di appartenenza dell''unità
     * documentaria da esibire {0}
     */
    public static final String RECDIP_003_001 = "RECDIP-003-001";

    /**
     * L''utente che ha attivato il servizio non esiste oppure non è attivo oppure la sua password
     * non è valida
     */
    ...
    /**
     * Nella struttura versante corrente, è già presente una richiesta di annullamento versamenti
     * con lo stesso codice con stato diverso da INVIO_FALLITO
     */
    ...
    /**
     * Per almeno una unità documentaria definita nella richiesta è necessario provvedere al suo
     * annullamento preventivo in PreIngest
     */
    public static final String RICH_ANN_VERS_013 = "RICH-ANN-VERS-013";

    /**
     * Nella struttura versante corrente è già presente una richiesta di annullamento versamenti con
     * lo stesso codice e con stato pari a CHIUSA
     */
    public static final String RICH_ANN_VERS_014 = "RICH-ANN-VERS-014";

    /**
     * Nella struttura versante corrente è già presente una richiesta di annullamento versamenti con
     * lo stesso codice e con stato pari a EVASA
     */
