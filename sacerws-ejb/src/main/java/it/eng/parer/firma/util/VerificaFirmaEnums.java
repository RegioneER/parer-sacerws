...
/*
 * Ereditato da "vecchio" modello (vedi CryptoEnums) Vengono riportati gli esiti (con relativi
 * messaggi hard coded) e le tipologie di riferimento temporale, che non sono riportabili sul
 * wrapper della verificare firma (modello dati per incapsulare il risultato della verifica firma e
 * quindi non legati a quelle logiche).
 */
public class VerificaFirmaEnums {
	...
	FORMATO_NON_CONOSCIUTO("Formato non conosciuto"),
	FORMATO_NON_CONFORME("Formato non conforme"),
	NON_AMMESSO_DELIB_45_CNIPA("Non ammetto delib45 cnipa"),
	...
	CERTIFICATO_ERRATO("Errore su certificato"),
	...
	OCSP_NON_SCARICABILE(
		"Il controllo non è svolto perché la risposta OCSP non è scaricabile dal server"), /**/
	OCSP_SCONOSCIUTO(
		"La risposta OCSP fornita dal server non ha informazioni sul certificato"), /**/
	...
	OCSP_REVOCATO(
		"La risposta OCSP fornita dal server indica che il certificato è stato revocato"), /**/
