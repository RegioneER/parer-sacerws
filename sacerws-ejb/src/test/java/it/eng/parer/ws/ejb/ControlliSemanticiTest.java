...
public class ControlliSemanticiTest {
	...
	return createEnterpriseArchive(ControlliSemanticiTest.class.getSimpleName(),
		createSacerWSJavaArchive(Arrays.asList(""), ControlliSemanticiTest.class,
			ControlliSemantici.class, it.eng.paginator.util.HibernateUtils.class),
	...
	final RispostaControlli rispostaControlli = controlliSemantici
		.caricaDefaultDaDB("Applicazione");
	...
	final RispostaControlli rispostaControlli = controlliSemantici
		.caricaDefaultDaDB(new String[] {
			"Applicazione", "Paginazione risultati" });
	assertNoErr(rispostaControlli);
    }

    @Test
    void checkIdStrut_queryIsOk() {
	for (Costanti.TipiWSPerControlli aggiornamentoVersamento : Costanti.TipiWSPerControlli
		.values()) {
	    final RispostaControlli rispostaControlli = controlliSemantici
		    .checkIdStrut(mockCsVersatore(), aggiornamentoVersamento, new Date());
	    assertNoErr(rispostaControlli);
	...
	final RispostaControlli rispostaControlli = controlliSemantici
		.checkSistemaMigraz("sistemaMigr");
	assertNoErr(rispostaControlli);
    }
	...
	for (ControlliSemantici.TipiGestioneUDAnnullate tipiGestioneUDAnnullate : ControlliSemantici.TipiGestioneUDAnnullate
		.values()) {
	    final RispostaControlli rispostaControlli = controlliSemantici
		    .checkChiave(mockCsChiave(), 0l, tipiGestioneUDAnnullate);
	    assertNoErr(rispostaControlli);
	}
    }
	...
	final RispostaControlli rispostaControlli = controlliSemantici
		.checkTipologiaUD("tipologiaUd", "descKey", 0L);
	assertNoErr(rispostaControlli);
    }
	...
	final RispostaControlli rispostaControlli = controlliSemantici
		.checkTipoRegistro("nomeTipoRegistro", "descKey", 0L);
	assertNoErr(rispostaControlli);
    }
	...
	final RispostaControlli rispostaControlli = controlliSemantici
		.checkTipoRegistro("nomeTipoRegistro", "descKey", 0L, "descKeyUdColl");
	assertNoErr(rispostaControlli);
    }
	...
	final RispostaControlli rispostaControlli = controlliSemantici
		.checkTipoRegistroTipoUD("nomeTipoRegistro", "descKey", "tipologiaUd", 0L, 0l);
	assertNoErr(rispostaControlli);
    }
	...
	final RispostaControlli rispostaControlli = controlliSemantici
		.caricaRegistroAnno("nomeTipoRegistro", "descKey", 2021L, 0L);
	assertNoErr(rispostaControlli);
    }
	...
	final RispostaControlli rispostaControlli = controlliSemantici
		.caricaRegistroAnno("nomeTipoRegistro", "descKey", 2021L, 0L, "descKeyUdColl");
	assertNoErr(rispostaControlli);
    }
	...
	RispostaControlli rispostaControlli = controlliSemantici.checkTipoDocumento("nomeTipoDoc",
		0L, true, "descChiaveDoc");
	assertNoErr(rispostaControlli);
	rispostaControlli = controlliSemantici.checkTipoDocumento("nomeTipoDoc", 0L, false,
		"descChiaveDoc");
	assertNoErr(rispostaControlli);
	...
	final RispostaControlli rispostaControlli = controlliSemantici
		.checkTipoStruttura("nomeTipoStruttura", 0L, "descChiaveDoc");
	assertNoErr(rispostaControlli);
    }
	...
	for (ControlliSemantici.TipologieComponente tipologieComponente : ControlliSemantici.TipologieComponente
		.values()) {
	    final RispostaControlli rispostaControlli = controlliSemantici.checkTipoComponente(
		    "nomeTipoComponente", 0l, tipologieComponente, "descChiaveComp");
	    assertNoErr(rispostaControlli);
	}
    }
	...
	for (CostantiDB.TipiUsoDatiSpec tipiUsoDatiSpec : CostantiDB.TipiUsoDatiSpec.values()) {
		...
		final RispostaControlli rispostaControlli = controlliSemantici
			.checkPresenzaDatiSpec(tipiUsoDatiSpec, tipoEntitySacer, "sistemaMig", 0L,
				0L, new Date());
		assertNoErr(rispostaControlli);
	...
	for (CostantiDB.TipiUsoDatiSpec tipiUsoDatiSpec : CostantiDB.TipiUsoDatiSpec.values()) {
	    for (CostantiDB.TipiEntitaSacer tipoEntitySacer : CostantiDB.TipiEntitaSacer.values()) {
		final RispostaControlli rispostaControlli = controlliSemantici.checkXSDDatiSpec(
			tipiUsoDatiSpec, tipoEntitySacer, "sistemaMig", 0L, 0L, new Date(),
			"versioneXsd");
		assertNoErr(rispostaControlli);
	    }
	}
	...
	for (CostantiDB.TipiUsoDatiSpec tipiUsoDatiSpec : CostantiDB.TipiUsoDatiSpec.values()) {
	    for (CostantiDB.TipiEntitaSacer tipoEntitySacer : CostantiDB.TipiEntitaSacer.values()) {
		final RispostaControlli rispostaControlli = controlliSemantici
			.checkPresenzaVersioneDatiSpec(tipiUsoDatiSpec, tipoEntitySacer,
				"sistemaMig", 0L, 0L, "versioneXsd");
		assertNoErr(rispostaControlli);
	    }
	}
    }
	...
	for (CostantiDB.TipiUsoDatiSpec tipiUsoDatiSpec : CostantiDB.TipiUsoDatiSpec.values()) {
		...
		final RispostaControlliAttSpec rispostaControlli = controlliSemantici
			.checkDatiSpecifici(tipiUsoDatiSpec, tipoEntitySacer, "sistemaMig", 0L, 0L,
				0L);
		assertNoErr(rispostaControlli);
	...
	for (ControlliSemantici.TipologieComponente tipologieComponente : ControlliSemantici.TipologieComponente
		.values()) {
	    final RispostaControlli rispostaControlli = controlliSemantici
		    .checkRiferimentoUD(mockCsChiave(), 0L, tipologieComponente, "descChiaveComp");
	    assertNoErr(rispostaControlli);
	}
    }
	...
	final RispostaControlli rispostaControlli = controlliSemantici.checkDocumentoInUd(0L,
		"idDocumento", "descUd");
	assertNoErr(rispostaControlli);
    }
	...
	final RispostaControlli rispostaControlli = controlliSemantici
		.calcAndcheckCdKeyNormalized(0L, mockCsChiave(), "cdKeyUnitaDocNormaliz");
	assertNoErr(rispostaControlli);
    }

    @Test
    void checkUniqueCdKeyNormalized_queryIsOk() {
	final RispostaControlli rispostaControlli = controlliSemantici.checkUniqueCdKeyNormalized(
		mockCsChiave(), 0l, 113l, "cdKeyNomarlized", new Date());
	assertNoErr(rispostaControlli);
    }
