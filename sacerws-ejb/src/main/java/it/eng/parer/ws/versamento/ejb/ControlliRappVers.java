...
public class ControlliRappVers {
    ...
    public RispostaControlli trovaVersSessUd(long idUd) {
        ...
        TypedQuery<VrsSessioneVers> query = entityManager.createQuery(queryStr, VrsSessioneVers.class);
    ...
    private RispostaControlli leggiXmlRappVers(long idSessVers, Map<String, String> xmlVersamentoOs) {
        RispostaControlli rispostaControlli;
        rispostaControlli = new RispostaControlli();
        rispostaControlli.setrBoolean(false);
        ...
        TypedQuery<VrsXmlDatiSessioneVers> query = entityManager.createQuery(queryStr, VrsXmlDatiSessioneVers.class);
