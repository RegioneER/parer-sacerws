...
public class SalvataggioUpdVersamentoAroHelper extends SalvataggioUpdVersamentoBaseHelper {
    ...
    public RispostaControlli aggiornaStatoConservazione(AroUnitaDoc tmpAroUnitaDoc,
            StrutturaUpdVers strutturaUpdVers, String nomeAgente) {
        ...
        try {
            ...
            if (scud == CostantiDB.StatoConservazioneUnitaDoc.AIP_GENERATO
                ...
                tmpAroUnitaDoc.setTiStatoConservazione(
            ...
            tmpRispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.ERR_666P,
                    "Errore interno nella fase di aggiornamento stato conservazione "
                            + e.getMessage()));
            tmpRispostaControlli.setrBoolean(false);
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRED)
    public RispostaControlli aggiornaProfiloArchivistico(UpdVersamentoExt versamento,
        ...
        try {
            ...
            if (versamento.hasPAFascicoloPrincipaleToUpd()
                ...
                tmpAroUnitaDoc.setDsOggettoSottofascicPrinc(
                        tmpAroUpdUnitaDoc.getDsOggettoSottofascicPrinc());
            }
            ...
            if (versamento.hasPAFascicoliSecondariToUp()
                ...
                for (AroUpdArchivSec updAroUpdArchivSec : tmpAroUpdUnitaDoc.getAroUpdArchivSecs()) {
                    ...
                    newAroArchivSec
                            .setDsOggettoSottofascic(updAroUpdArchivSec.getDsOggettoSottofascic());
                    // idStrut
            ...
            tmpRispostaControlli.setCodErr(MessaggiWSBundle.ERR_666P);
            tmpRispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.ERR_666P,
                    "Errore interno nella fase di aggiornamento aroUnitaDoc profilo archivistico "
                            + e.getMessage()));
            tmpRispostaControlli.setrBoolean(false);
            getLogger().error(
                    "Errore interno nella fase di aggiornamento aroUnitaDoc profilo archivistico",
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRED)
    public RispostaControlli aggiornaProfiloNormativo(AroUnitaDoc tmpAroUnitaDoc,
        ...
        try {
            ...
            lstXmlModelloSessioneVers = retreiveXmlVersamentiModelloXsdUnitaDoc(
            ...
            if (!lstXmlModelloSessioneVers.isEmpty()) {
                VrsXmlModelloSessioneVers vrsXmlModelloSessioneVers = lstXmlModelloSessioneVers
                        .get(0);
                ...
                if (!tmpSessioneVer.isEmpty()) {
                    ...
                    if (strutturaUpdVers.getIdStruttura() != 0) {
                        tmpXmlModelloSessioneVers
                                .setIdStrut(new BigDecimal(strutturaUpdVers.getIdStruttura()));
                    }
                    ...
                    tmpXmlModelloSessioneVers.setDecUsoModelloXsdUniDoc(
                            entityManager.find(DecUsoModelloXsdUniDoc.class,
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRED)
    public RispostaControlli aggiornaDocumentiCollegati(AroUnitaDoc tmpAroUnitaDoc,
            AroUpdUnitaDoc tmpAroUpdUnitaDoc) {
        RispostaControlli tmpRispostaControlli = new RispostaControlli();
        tmpRispostaControlli.setrBoolean(false);
        ...
        try {
            ...
            for (AroUpdLinkUnitaDoc updAroLinkUnitaDoc : tmpAroUpdUnitaDoc
                    .getAroUpdLinkUnitaDocs()) {
                ...
                newAroLinkUnitaDoc.setCdRegistroKeyUnitaDocLink(
                        updAroLinkUnitaDoc.getCdRegistroKeyUnitaDocLink());
                // FK
            ...
            tmpRispostaControlli.setCodErr(MessaggiWSBundle.ERR_666P);
            tmpRispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.ERR_666P,
                    "Errore interno nella fase di aggiornamento aroUnitaDoc documenti collegati "
                            + e.getMessage()));
            tmpRispostaControlli.setrBoolean(false);
            getLogger().error(
                    "Errore interno nella fase di aggiornamento aroUnitaDoc documenti collegati",
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRED)
    public RispostaControlli aggiornaDatiSpecificiUd(AroUnitaDoc tmpAroUnitaDoc,
            AroUpdUnitaDoc tmpAroUpdUnitaDoc,
        ...
        try {
            ...
            for (AroUpdDatiSpecUnitaDoc tmpAroUpdDocUnitaDoc : tmpAroUpdUnitaDoc
                ...
                if (tmpAroUpdDocUnitaDoc.getTiEntitaSacer()
                        .equals(TiEntitaAroUpdDatiSpecUnitaDoc.UPD_UNI_DOC)
                        && tmpAroUpdDocUnitaDoc.getTiUsoXsd()
                                .equals(tiUsoXsdAroUpdDatiSpecUnitaDoc)) {

                    TipiUsoDatiSpec tipiUsoDatiSpec = tiUsoXsdAroUpdDatiSpecUnitaDoc
                            .equals(TiUsoXsdAroUpdDatiSpecUnitaDoc.VERS) ? TipiUsoDatiSpec.VERS
                                    : TipiUsoDatiSpec.MIGRAZ;
                    tmpRispostaControlli = this.checkUsoXsdDatiSpecifici(
                            tmpAroUnitaDoc.getIdUnitaDoc(), tipiUsoDatiSpec,
                            TipiEntitaSacer.UNI_DOC/* fixed */);
                    ...
                    if (tmpRispostaControlli.getrLong() != -1) {
                        ...
                        // (ARO_VALORE_ATTRIB_DATI_SPEC) determinati mediante il record relativo
                        // all�uso
                        // del XSD per dati specifici relativo all�unita doc in modifica con tipo
                        // entita
                        ...
                        // delete vecchia tabella
                        entityManager.flush();
                        // delete nuova tabella (doppio binario)
                        entityManager.createQuery("DELETE FROM AroValoreAttribDatiSpecRicDs r "
                                + "WHERE r.idStrut = :idStrut "
                                + "AND r.idUsoXsdDatiSpec = :idUsoXsdDatiSpec "
                                + "AND r.idUnitaDoc = :idUnitaDoc " + "AND r.tiUsoXsd = :tiUsoXsd "
                                + "AND r.tiEntitaSacer = :tiEntitaSacer " + "AND r.idDoc IS NULL")
                                .setParameter("idStrut",
                                        new BigDecimal(tmpAroUnitaDoc.getIdOrgStrut()))
                                .setParameter("idUsoXsdDatiSpec",
                                        tmpUsoXsdDatiSpec.getIdUsoXsdDatiSpec())
                                .setParameter("idUnitaDoc", tmpAroUnitaDoc.getIdUnitaDoc())
                                .setParameter("tiUsoXsd", tipiUsoDatiSpec.name())
                                .setParameter("tiEntitaSacer", TipiEntitaSacer.UNI_DOC.name())
                                .executeUpdate();
                        entityManager.flush();

                        // 4.1.2. se esiste record in ARO_USO_XSD_DATI_SPEC relativo all�unita doc
                        // in
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRED)
    public RispostaControlli aggiornaDocumento(AroUpdUnitaDoc tmpAroUpdUnitaDoc,
            StrutturaUpdVers strutturaUpdVers) {
        RispostaControlli tmpRispostaControlli = new RispostaControlli();
        tmpRispostaControlli.setrBoolean(false);
        ...
        try {
            ...
            for (AroUpdDocUnitaDoc aroUpdDocUnitaDoc : tmpAroUpdUnitaDoc.getAroUpdDocUnitaDocs()) {
                ...
                if (countDoc != 1) {
                    ...
                    tmpRispostaControlli.setDsErr(MessaggiWSBundle.getString(
                ...
                UpdDocumentoVers updDocumentoVers = strutturaUpdVers.getDocumentiAttesi().stream()
                        .filter(d -> d.getIdRecDocumentoDB() == aroDoc.getIdDoc())
                        .collect(Collectors.toList()).get(0); // single
                // result
                ...
                if (updDocumentoVers.getRifUpdDocumento().getDatiSpecifici() != null) {
                    for (AroUpdDatiSpecUnitaDoc aroUpdDatiSpecUnitaDoc : aroUpdDocUnitaDoc
                            .getAroUpdDatiSpecUnitaDocs()) {
                        tmpRispostaControlli = aggiornaDatiSpecDoc(aroDoc, aroUpdDatiSpecUnitaDoc,
                ...
                // ciclo componenti
                for (AroUpdCompUnitaDoc aroUpdCompUnitaDoc : aroUpdDocUnitaDoc
                    ...
                    for (UpdComponenteVers updComponenteVers : updDocumentoVers
                            .getUpdComponentiAttesi().stream()
                        ...
                        if (updComponenteVers.getMyUpdComponente().getDatiSpecifici() != null) {
                            ...
                            for (AroUpdDatiSpecUnitaDoc aroUpdDatiSpecUnitaDoc : aroUpdDocUnitaDoc
                                    .getAroUpdDatiSpecUnitaDocs()) {
                                tmpRispostaControlli = aggiornaDatiSpecDoc(aroDoc, aroCompDoc,
                                        aroUpdDatiSpecUnitaDoc, strutturaUpdVers,
                                        TiUsoXsdAroUpdDatiSpecUnitaDoc.VERS,
                                        TiEntitaAroUpdDatiSpecUnitaDoc.UPD_COMP);
                            }
                        }
                        // 2. se su documento da aggiornare il tag �DatiSpecificiMigrazione� e� da
                        // aggiornare
                        if (updComponenteVers.getMyUpdComponente()
                                .getDatiSpecificiMigrazione() != null) {
                            for (AroUpdDatiSpecUnitaDoc aroUpdDatiSpecUnitaDoc : aroUpdDocUnitaDoc
                                    .getAroUpdDatiSpecUnitaDocs()) {
                                tmpRispostaControlli = aggiornaDatiSpecDoc(aroDoc, aroCompDoc,
                                        aroUpdDatiSpecUnitaDoc, strutturaUpdVers,
                                        TiUsoXsdAroUpdDatiSpecUnitaDoc.MIGRAZ,
                                        TiEntitaAroUpdDatiSpecUnitaDoc.UPD_COMP);
                            }
                        }
    ...
    private RispostaControlli aggiornaDatiSpecDoc(AroDoc aroDoc,
    ...
    private RispostaControlli aggiornaDatiSpecDoc(AroDoc aroDoc, AroCompDoc aroCompDoc,
        ...
        try {
            ...
            if (tmpAroUpdDatiSpecUnitaDoc.getTiEntitaSacer().equals(tiEntitaAroUpdDatiSpecUnitaDoc)
                    && tmpAroUpdDatiSpecUnitaDoc.getTiUsoXsd()
                            .equals(tiUsoXsdAroUpdDatiSpecUnitaDoc)) {

                tmpRispostaControlli = this.checkUsoXsdDatiSpecifici(
                        TiEntitaAroUpdDatiSpecUnitaDoc.UPD_DOC
                                .equals(tiEntitaAroUpdDatiSpecUnitaDoc) ? aroDoc.getIdDoc()
                ...
                if (tmpRispostaControlli.getrLong() != -1) {
                    ...
                    entityManager.flush();
                    // delete nuova tabella (doppio binario)
                    Long idDocRicDs = null;
                    if (TipiEntitaSacer.DOC.name().equals(tmpUsoXsdDatiSpec.getTiEntitaSacer())
                            && tmpUsoXsdDatiSpec.getAroDoc() != null) {
                        idDocRicDs = tmpUsoXsdDatiSpec.getAroDoc().getIdDoc();
                    } else if (TipiEntitaSacer.COMP.name()
                            .equals(tmpUsoXsdDatiSpec.getTiEntitaSacer())
                            && tmpUsoXsdDatiSpec.getAroCompDoc() != null) {
                        idDocRicDs = tmpUsoXsdDatiSpec.getAroCompDoc().getIdCompDoc();
                    }
                    entityManager.createQuery("DELETE FROM AroValoreAttribDatiSpecRicDs r "
                            + "WHERE r.idStrut = :idStrut "
                            + "AND r.idUsoXsdDatiSpec = :idUsoXsdDatiSpec "
                            + "AND r.idUnitaDoc = :idUnitaDoc " + "AND r.tiUsoXsd = :tiUsoXsd "
                            + "AND r.tiEntitaSacer = :tiEntitaSacer "
                            + "AND ((:idDoc IS NULL AND r.idDoc IS NULL) OR r.idDoc = :idDoc)")
                            .setParameter("idStrut", tmpUsoXsdDatiSpec.getIdStrut())
                            .setParameter("idUsoXsdDatiSpec",
                                    tmpUsoXsdDatiSpec.getIdUsoXsdDatiSpec())
                            .setParameter("idUnitaDoc",
                                    tmpUsoXsdDatiSpec.getAroUnitaDoc().getIdUnitaDoc())
                            .setParameter("tiUsoXsd", tmpUsoXsdDatiSpec.getTiUsoXsd())
                            .setParameter("tiEntitaSacer", tmpUsoXsdDatiSpec.getTiEntitaSacer())
                            .setParameter("idDoc", idDocRicDs).executeUpdate();
                    entityManager.flush();
                ...
                if (TiEntitaAroUpdDatiSpecUnitaDoc.UPD_DOC.equals(tiEntitaAroUpdDatiSpecUnitaDoc)) {
                    ...
                    //
                    UpdDocumentoVers updDocumentoVers = strutturaUpdVers.getDocumentiAttesi()
                            .stream().filter(d -> d.getIdRecDocumentoDB() == aroDoc.getIdDoc())
                            .collect(Collectors.toList()).get(0); // single
                    // result
                    ...
                    Map<String, DatoSpecifico> datiSpecifici = TiUsoXsdAroUpdDatiSpecUnitaDoc.VERS
                            .equals(tiUsoXsdAroUpdDatiSpecUnitaDoc)
                                    ? updDocumentoVers.getDatiSpecifici()
                ...
                if (TiEntitaAroUpdDatiSpecUnitaDoc.UPD_COMP
                        .equals(tiEntitaAroUpdDatiSpecUnitaDoc)) {

                    // add on list
                    aroCompDoc.getAroUsoXsdDatiSpecs().add(tmpUsoXsdDatiSpec);

                    for (UpdDocumentoVers updDocumentoVers : strutturaUpdVers
                            .getDocumentiAttesi()) {
                        for (UpdComponenteVers updComponenteVers : updDocumentoVers
                                .getUpdComponentiAttesi().stream()
                                .filter(d -> d.getIdRecDB() == aroCompDoc.getIdCompDoc())
                                .collect(Collectors.toList())) {
                            // 4.1.4.1. registra record in ARO_VALORE_ATTRIB_DATI_SPEC,
                            // specificando:
                            Map<String, DatoSpecifico> datiSpecifici = TiUsoXsdAroUpdDatiSpecUnitaDoc.VERS
                                    .equals(tiUsoXsdAroUpdDatiSpecUnitaDoc)
                                            ? updComponenteVers.getDatiSpecifici()
            ...
            tmpRispostaControlli.setCodErr(MessaggiWSBundle.ERR_666P);
            tmpRispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.ERR_666P,
                    "Errore interno nella fase di aggiornamento dati specifici documento "
                            + e.getMessage()));
            tmpRispostaControlli.setrBoolean(false);
            getLogger().error("Errore interno nella fase di aggiornamento dati specifici documento",
                    e);
        }
    ...
    private void buildDatoSpecifico(AroDoc aroDoc, AroUsoXsdDatiSpec tmpUsoXsdDatiSpec,
        ...
        for (DatoSpecifico datoSpec : datiSpecifici.values()) {
            ...
            if (datoSpec.getValore() != null && !datoSpec.getValore().isEmpty()) {
                ...
                boolean isUniDoc = TipiEntitaSacer.UNI_DOC.name().equals(tiEntitaSacer);
                Long idDocPerRicDs = null;
                if (TipiEntitaSacer.DOC.name().equals(tiEntitaSacer)) {
                    idDocPerRicDs = aroDoc.getIdDoc();
                } else if (TipiEntitaSacer.COMP.name().equals(tiEntitaSacer)
                        && tmpUsoXsdDatiSpec.getAroCompDoc() != null) {
    ...
    public RispostaControlli aggiornaAggregazioni(AroUnitaDoc tmpAroUnitaDoc) {
        ...
        try {
            ...
            List<BigDecimal> idVerSeries = this
                    .retrieveSerVLisVerserByUpdUd(tmpAroUnitaDoc.getIdUnitaDoc());
            for (BigDecimal idVerSerie : idVerSeries) {
                SerVerSerie verSerie = entityManager.find(SerVerSerie.class,
            ...
            List<FasVLisFascByUpdUdId> idFascs = this
                    .retrieveFasVLisFascByUpdUdId(tmpAroUnitaDoc.getIdUnitaDoc());
            for (FasVLisFascByUpdUdId idFasc : idFascs) {
                FasFascicolo fasFascicolo = entityManager.find(FasFascicolo.class,
                        idFasc.getIdFascicolo().longValue());
    ...
    private List<VrsDatiSessioneVers> retreiveVrsDatiSessioneVersByIsSessioneVers(
        ...
        TypedQuery<VrsDatiSessioneVers> query = entityManager.createQuery(queryStr,
                VrsDatiSessioneVers.class);
     ...
     * contenuto di tipo EFFETTIVO sia presente l�unit� documentaria in aggiornamento
     *
     ...
     * cui contenuto e� presente l�unit� documentaria in aggiornamento
     *
