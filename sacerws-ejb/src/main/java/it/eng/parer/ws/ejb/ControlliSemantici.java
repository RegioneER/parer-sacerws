...
public class ControlliSemantici {
    ...
    public RispostaControlli caricaDefaultDaDB(String[] tipoPars) {
        ...
        try {
            ...
            Map<String, String> tmpDefaults = config
            ...
            if (!tmpDefaults.isEmpty()) {
                ...
                log.error(
                        ...
                        tipoPars.length > 0 ? String.join(",", tipoPars)
                                : "default_params_not_configured");
            }
        } catch (Exception e) {
            rispostaControlli.setCodErr(MessaggiWSBundle.ERR_666);
            rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.ERR_666,
        ...
        try {
            ...
            if (orgStrutS.get(0).getFlTemplate().equals("1")) {
                if (tipows == Costanti.TipiWSPerControlli.VERSAMENTO_RECUPERO
                    ...
                    rispostaControlli.setDsErr(
                            MessaggiWSBundle.getString(MessaggiWSBundle.UD_001_015, strut));
                    return rispostaControlli;
            ...
            if (orgStrutS.get(0).getDtIniValStrut() != null
                ...
                // libreria
                long dtIni = DateUtils.truncate(orgStrutS.get(0).getDtIniValStrut(), Calendar.DATE)
                        .getTime();
                long dtFine = DateUtils
                        .truncate(orgStrutS.get(0).getDtFineValStrut(), Calendar.DATE).getTime();
            ...
            if (hasDateErr) {
                if (tipows == Costanti.TipiWSPerControlli.VERSAMENTO_RECUPERO
                    ...
                    rispostaControlli.setDsErr(
                            MessaggiWSBundle.getString(MessaggiWSBundle.UD_001_019, strut));
                } else if (tipows == Costanti.TipiWSPerControlli.VERSAMENTO_FASCICOLO) {
    ...
    public RispostaControlli checkSistemaMigraz(String sistemaMig) {
        ...
        try {
            ...
            if (numSist > 0) {
                ...
                rispostaControlli.setDsErr(
                        MessaggiWSBundle.getString(MessaggiWSBundle.UD_001_014, sistemaMig));
            }
        } catch (Exception e) {
            rispostaControlli.setCodErr(MessaggiWSBundle.ERR_666);
            rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.ERR_666,
    ...
    public RispostaControlli checkTipologiaUD(String tipologiaUD, String descKey,
        ...
        try {
            // ricavo le ud presenti in base ai parametri impostati
            String queryStr = "select tud " + "from DecTipoUnitaDoc tud "
                    + "where tud.orgStrut.idStrut = :idStrutIn "
                    + " and UPPER(tud.nmTipoUnitaDoc) = :nmTipoUnitaDocIn "
            ...
            if (tipoUnitaDocS.isEmpty()) {
                ...
                rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.UD_003_001,
                        descKey, tipologiaUD));
                return rispostaControlli;
            }
            ...
            if (tipoUnitaDocS.size() > 1) {
                ...
                rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.UD_003_005,
                        descKey, tipologiaUD));
                return rispostaControlli;
            }
            ...
            rispostaControlli.setrObject(tud);// TODO: aggiunto l'oggetto (utile per altri
            // controlli)
            rispostaControlli.setrBoolean(true);
        } catch (Exception e) {
            rispostaControlli.setCodErr(MessaggiWSBundle.ERR_666);
    ...
    public RispostaControlli checkTipoRegistro(String nomeTipoRegistro, String descKey,
            long idStruttura) {
        return this.checkTipoRegistro(nomeTipoRegistro, descKey, idStruttura, null);
    }

    public RispostaControlli checkTipoRegistro(String nomeTipoRegistro, String descKey,
            long idStruttura, String descKeyUdColl) {
        RispostaControlli rispostaControlli;
        rispostaControlli = new RispostaControlli();
        rispostaControlli.setrBoolean(false);
        ...
        try {
            String queryStr = "select tud " + "from DecRegistroUnitaDoc tud "
                    ...
                    + " and tud.dtIstituz <= :dataDiOggiIn "
                    + " and tud.dtSoppres > :dataDiOggiIn "; // da notare
            // STRETTAMENTE
            // MAGGIORE della
            // data di
            // riferimento!!!
            ...
            if (tipoRegistroUDs.isEmpty()) {
                if (descKeyUdColl == null) {
                    ...
                    rispostaControlli.setDsErr(MessaggiWSBundle
                            .getString(MessaggiWSBundle.UD_003_002, descKey, nomeTipoRegistro));
                } else {
                    rispostaControlli.setCodErr(MessaggiWSBundle.UD_004_003);
                    rispostaControlli.setDsErr(MessaggiWSBundle
                            .getString(MessaggiWSBundle.UD_004_003, descKey, descKeyUdColl));
                }
                return rispostaControlli;
            }
    ...
    public RispostaControlli checkTipoRegistroTipoUD(String nomeTipoRegistro, String descKey,
            String tipologiaUD, long idStruttura, long idTipologiaUD) {
        RispostaControlli rispostaControlli;
        rispostaControlli = new RispostaControlli();
        rispostaControlli.setrBoolean(false);
        ...
        try {
            ...
            if (tipoRegistroUDs.isEmpty()) {
                rispostaControlli.setCodErr(MessaggiWSBundle.UD_003_002);
                rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.UD_003_002,
                        descKey, nomeTipoRegistro));
                return rispostaControlli;
            }
            ...
            if (tipoRegistroUDAmms.isEmpty()) {
                ...
                rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.UD_003_003,
                        descKey, nomeTipoRegistro, tipologiaUD));
                return rispostaControlli;
            }

            tmpDatiRegistroFiscale.setIdOrgStrut(idStruttura);
            tmpDatiRegistroFiscale.setIdRegistroUnitaDoc(tmpIdReg);
            tmpDatiRegistroFiscale
                    .setFlRegistroFisc(tipoRegistroUDs.get(0).getFlRegistroFisc().equals("1"));
    ...
    public RispostaControlli caricaRegistroAnno(String nomeTipoRegistro, String descKey, Long anno,
        ...
        try {
            String queryStr = "select t from DecAaRegistroUnitaDoc t "
                    ...
                    + " and t.aaMinRegistroUnitaDoc <= :annoUDIn "
                    + " and (t.aaMaxRegistroUnitaDoc >= :annoUDIn "
            ...
            query.setParameter("annoCorrenteIn",
                    new BigDecimal(new GregorianCalendar().get(Calendar.YEAR)));

            List<DecAaRegistroUnitaDoc> tmpLst = query.getResultList();
            if (tmpLst.size() == 1) {
                DecAaRegistroUnitaDoc tmpAaRegistroUnitaDoc = tmpLst.get(0);
                ConfigRegAnno tmpConfAnno = this
                        .caricaPartiAARegistro(tmpAaRegistroUnitaDoc.getIdAaRegistroUnitaDoc());
                if (!tmpConfAnno.getParti().isEmpty()) {
                    ...
                    if (descKeyUdColl == null) {
                        ...
                        rispostaControlli.setDsErr(MessaggiWSBundle.getString(
                                MessaggiWSBundle.UD_003_004, descKey,
                                nomeTipoRegistro
                                        + ": non è stata configurata la numerazione per il periodo",
                                anno.toString()));
                    } else {
                        rispostaControlli.setCodErr(MessaggiWSBundle.UD_004_004);
                        rispostaControlli.setDsErr(MessaggiWSBundle.getString(
                                MessaggiWSBundle.UD_004_004, descKey, descKeyUdColl,
                                ": non è stata configurata la numerazione per il periodo"));
                    }
                    return rispostaControlli;
                }
                ...
                if (descKeyUdColl == null) {
                    rispostaControlli.setCodErr(MessaggiWSBundle.UD_003_004);
                    rispostaControlli
                            .setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.UD_003_004,
                                    descKey, nomeTipoRegistro, anno.toString()));
                } else {
                    rispostaControlli.setCodErr(MessaggiWSBundle.UD_004_004);
                    rispostaControlli.setDsErr(MessaggiWSBundle
                            .getString(MessaggiWSBundle.UD_004_004, descKey, descKeyUdColl, ""));
                }
                return rispostaControlli;
            }
        } catch (Exception e) {
    ...
    public RispostaControlli checkTipoDocumento(String nomeTipoDoc, long idStruttura,
            boolean documentoPrinc, String descChiaveDoc) {
        ...
        try {
            ...
            // ricavo le ud presenti in base ai parametri impostati
            String queryStr = "select td " + "from DecTipoDoc td "
                    + "where td.orgStrut.idStrut = :idStrutIn "
                    + " and UPPER(td.nmTipoDoc) = :nmTipoDocIn "
                    + " and td.dtIstituz <= :dataDiOggiIn " + " and td.dtSoppres > :dataDiOggiIn "; // da
            // notare
            // STRETTAMENTE
            // MAGGIORE
            // della
            ...
            if (tipoDocS.isEmpty()) {
                ...
                rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.DOC_001_001,
                        descChiaveDoc, nomeTipoDoc));
                return rispostaControlli;
            }
            ...
            if (tipoDocS.size() > 1) {
                ...
                rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.DOC_001_003,
                        descChiaveDoc, nomeTipoDoc));
                return rispostaControlli;
            }
            ...
            if (documentoPrinc && (td.getFlTipoDocPrincipale() == null
                    || td.getFlTipoDocPrincipale().equals("0"))) {
                rispostaControlli.setCodErr(MessaggiWSBundle.DOC_001_002);
                rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.DOC_001_002,
                        descChiaveDoc, nomeTipoDoc));
                return rispostaControlli;
            }
    ...
    public RispostaControlli checkTipoStruttura(String nomeTipoStruttura, long idStruttura,
        ...
        try {
            ...
            String queryStr = "select tsd " + "from DecTipoStrutDoc tsd "
                    + "where tsd.orgStrut.idStrut = :idStrutIn "
                    + " and tsd.nmTipoStrutDoc = :nmTipoStrutDocIn "
                    + " and tsd.dtIstituz <= :dataDiOggiIn "
                    + " and tsd.dtSoppres > :dataDiOggiIn "; // da notare STRETTAMENTE MAGGIORE
            // della data di
            // riferimento!!!

            javax.persistence.Query query = entityManager.createQuery(queryStr,
                    DecTipoStrutDoc.class);
            query.setParameter("idStrutIn", idStruttura);
            ...
            if (decTipoStrutDocS.isEmpty()) {
                ...
                rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.DOC_005_001,
                        descChiaveDoc, nomeTipoStruttura));
                return rispostaControlli;
            }
    ...
    public RispostaControlli checkTipoComponente(String nomeTipoComponente, long idTipoStrutDoc,
        ...
        try {
            ...
            String queryStr = "select tcd " + "from DecTipoCompDoc tcd "
                    ...
                    + " and tcd.nmTipoCompDoc = :nmTipoCompDocIn "
                    + " and tcd.dtIstituz <= :dataDiOggiIn "
                    + " and tcd.dtSoppres > :dataDiOggiIn "; // da notare STRETTAMENTE MAGGIORE
            // della data di
            // riferimento!!!

            javax.persistence.Query query = entityManager.createQuery(queryStr,
                    DecTipoCompDoc.class);
            ...
            if (tComp == TipologieComponente.COMPONENTE) {
                ...
                if (decTipoCompDocS.isEmpty()) {
                    ...
                    rispostaControlli.setDsErr(MessaggiWSBundle.getString(
                            MessaggiWSBundle.COMP_001_001, descChiaveComp, nomeTipoComponente));
                    return rispostaControlli;
                }
                ...
                for (DecTipoCompDoc tcd : decTipoCompDocS) {
                    ...
                    if (!tcd.getTiUsoCompDoc().equals(CostantiDB.TipoUsoComponente.CONTENUTO)
                        ...
                        rispostaControlli.setDsErr(MessaggiWSBundle
                                .getString(MessaggiWSBundle.COMP_001_002, descChiaveComp));
                        return rispostaControlli;
                    }
                }
                rispostaControlli.setrBoolean(true);
                ...
                if (decTipoCompDocS.isEmpty()) {
                    ...
                    rispostaControlli.setDsErr(MessaggiWSBundle.getString(
                            MessaggiWSBundle.SUBCOMP_001_001, descChiaveComp, nomeTipoComponente));
                    return rispostaControlli;
                }
                ...
                for (DecTipoCompDoc tcd : decTipoCompDocS) {
                    ...
                    if (!tcd.getTiUsoCompDoc().equals(CostantiDB.TipoUsoComponente.FIRMA)
                            ...
                            && !tcd.getTiUsoCompDoc()
                                    .equals(CostantiDB.TipoUsoComponente.FIRMA_ELETTRONICA)) {
                        // Il tipo componente non ha tipo di uso corretto
                        rispostaControlli.setCodErr(MessaggiWSBundle.SUBCOMP_001_002);
                        rispostaControlli.setDsErr(MessaggiWSBundle
                                .getString(MessaggiWSBundle.SUBCOMP_001_002, descChiaveComp));
                        return rispostaControlli;
                    }
                }
                rispostaControlli.setrBoolean(true);
    ...
    public RispostaControlli checkTipoRappComponente(String nomeTipoRapprComponente,
            long idStruttura, String descChiaveComp) {
        RispostaControlli rispostaControlli;
        rispostaControlli = new RispostaControlli();
        ...
        try {
            // ricavo i record in base ai parametri impostati
            String queryStr = "select trc " + "from DecTipoRapprComp trc "
                    + "where trc.orgStrut.idStrut = :idStrutIn "
                    + " and trc.nmTipoRapprComp = :nmTipoRapprCompIn "
                    + " and trc.dtIstituz <= :dataDiOggiIn "
                    + " and trc.dtSoppres > :dataDiOggiIn "; // da notare STRETTAMENTE MAGGIORE
            // della data di
            // riferimento!!!

            javax.persistence.Query query = entityManager.createQuery(queryStr,
                    DecTipoRapprComp.class);
            query.setParameter("idStrutIn", idStruttura);
            ...
            if (decTipoRapprCompS.isEmpty()) {
                ...
                rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.COMP_003_001,
                        descChiaveComp, nomeTipoRapprComponente));
                return rispostaControlli;
            }
    ...
    public RispostaControlli checkPresenzaDatiSpec(TipiUsoDatiSpec tiUsoXsd,
            TipiEntitaSacer tipoEntitySacer, String sistemaMig, long idStruttura,
            long idTipoEntitySacer, Date dataRiferimento) {
        RispostaControlli rispostaControlli;
        rispostaControlli = new RispostaControlli();
        rispostaControlli.setrBoolean(false);
        Long numXsd;
        ...
        try {
            if (tiUsoXsd == TipiUsoDatiSpec.MIGRAZ) {
                String queryStr = "select count(t) from DecXsdDatiSpec t "
                        + "where t.orgStrut.idStrut = :idStrutIn "
                        + " and t.tiUsoXsd = :tiUsoXsdIn "
                        + " and t.nmSistemaMigraz = :nmSistemaMigrazIn "
    ...
    public RispostaControlli checkXSDDatiSpec(TipiUsoDatiSpec tiUsoXsd,
            TipiEntitaSacer tipoEntitySacer, String sistemaMig, long idStruttura,
            long idTipoEntitySacer, Date dataRiferimento, String versioneXsd) {
        RispostaControlli rispostaControlli;
        rispostaControlli = new RispostaControlli();
        rispostaControlli.setrBoolean(false);
        ...
        try {
            if (tiUsoXsd == TipiUsoDatiSpec.MIGRAZ) {
                String queryStr = "select t from DecXsdDatiSpec t "
                        + "where t.orgStrut.idStrut = :idStrutIn "
                        + " and t.tiUsoXsd = :tiUsoXsdIn "
                        + " and t.nmSistemaMigraz = :nmSistemaMigrazIn "
                        + " and t.tiEntitaSacer = :tiEntitaSacerIn "
                        + " and t.cdVersioneXsd = :cdVersioneXsdIn "
                        + " and t.dtIstituz <= :dataRifIn " + " and t.dtSoppres > :dataRifIn ";
                // da notare STRETTAMENTE MAGGIORE della data di riferimento!!!

                javax.persistence.Query query = entityManager.createQuery(queryStr,
                        DecXsdDatiSpec.class);
                query.setParameter("idStrutIn", idStruttura);
                query.setParameter("tiUsoXsdIn", tiUsoXsd.name());
                query.setParameter("nmSistemaMigrazIn", sistemaMig);
                query.setParameter("tiEntitaSacerIn", tipoEntitySacer.name());
                ...
                String queryStr = String.format("select t from DecXsdDatiSpec t "
                        + "where t.orgStrut.idStrut = :idStrutIn "
                        + " and t.tiUsoXsd = :tiUsoXsdIn " + " and %s = :idTipoEntitySacerIn "
                        + " and t.tiEntitaSacer = :tiEntitaSacerIn "
                        + " and t.cdVersioneXsd = :cdVersioneXsdIn "
    ...
    public RispostaControlli checkPresenzaVersioneDatiSpec(TipiUsoDatiSpec tiUsoXsd,
            TipiEntitaSacer tipoEntitySacer, String sistemaMig, long idStruttura,
            long idTipoEntitySacer, String versioneXsd) {
        RispostaControlli rispostaControlli;
        rispostaControlli = new RispostaControlli();
        rispostaControlli.setrBoolean(false);
        Long numXsd;
    ...
    public RispostaControlliAttSpec checkDatiSpecifici(TipiUsoDatiSpec tipoUsoAttr,
            TipiEntitaSacer tipoEntitySacer, String sistemaMig, long idStruttura,
            long idTipoEntitySacer, long idXsdDatiSpec) {
        ...
        try {
            if (tipoUsoAttr == TipiUsoDatiSpec.MIGRAZ) {
                String queryStr = "select t from DecAttribDatiSpec t "
                        + "join t.decXsdAttribDatiSpecs attXsd "
                        + "where t.orgStrut.idStrut = :idStrutIn "
                        + " and t.tiUsoAttrib = :tiUsoAttribIn "
                        + " and t.nmSistemaMigraz = :nmSistemaMigrazIn "
                        + " and t.tiEntitaSacer = :tiEntitaSacerIn "
                        + " and attxsd.decXsdDatiSpec.idXsdDatiSpec = :idXsdDatiSpecIn ";

                javax.persistence.Query query = entityManager.createQuery(queryStr,
                        DecAttribDatiSpec.class);
                query.setParameter("idStrutIn", idStruttura);
                ...
                if (!lstAttribDatiSpecs.isEmpty()) {
                    ...
                    for (DecAttribDatiSpec td : lstAttribDatiSpecs) {
                        ...
                        rispostaControlli.getDatiSpecifici().put(td.getNmAttribDatiSpec().trim(),
                                tmpDatoSpecifico);
                    }
                }
            } else {
                ...
                String queryStr = String.format("select t from DecAttribDatiSpec t "
                        + "join t.decXsdAttribDatiSpecs attXsd "
                        + "where t.orgStrut.idStrut = :idStrutIn "
                        + " and t.tiUsoAttrib = :tiUsoAttribIn " + " and %s = :idTipoEntitySacerIn "
                        + " and t.tiEntitaSacer = :tiEntitaSacerIn "
                        + " and attxsd.decXsdDatiSpec.idXsdDatiSpec = :idXsdDatiSpecIn ",
                        tmpTipoEntita);
                ...
                if (!lstAttribDatiSpecs.isEmpty()) {
                    ...
                    for (DecAttribDatiSpec td : lstAttribDatiSpecs) {
                        ...
                        tmpDatoSpecifico.setIdDatoSpec(td.getIdAttribDatiSpec());
                        rispostaControlli.getDatiSpecifici().put(td.getNmAttribDatiSpec(),
                                tmpDatoSpecifico);
                    }
                }
            }
    ...
    public RispostaControlli checkRiferimentoUD(CSChiave key, long idStrutturaVersante,
            TipologieComponente tComp, String descChiaveComp) {
        RispostaControlli rispostaControlli;
        rispostaControlli = new RispostaControlli();
        ...
        try {
            ...
            String queryStr = "select comp_doc " + "from AroUnitaDoc ud " + "join ud.aroDocs doc "
                    + "join doc.aroStrutDocs strut_doc " + "join strut_doc.aroCompDocs comp_doc "
                    + "where " + " trim(doc.tiDoc) = 'PRINCIPALE' "
                    + " and strut_doc.flStrutOrig = '1' " + " and ud.orgStrut.idStrut = :idStrutIn "
                    + " and ud.cdKeyUnitaDoc = :cdKeyUnitaDocIn "
                    + " and ud.aaKeyUnitaDoc = :aaKeyUnitaDocIn "
                    + " and ud.cdRegistroKeyUnitaDoc = :cdRegistroKeyUnitaDocIn "
                    + " and ud.dtAnnul > :dataDiOggiIn" + " and comp_doc.tiSupportoComp = 'FILE'";
            ...
            if (aroCompDocs == null || aroCompDocs.isEmpty()) {
                if (tComp == TipologieComponente.COMPONENTE) {
                    ...
                    rispostaControlli
                            .setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.COMP_008_005,
                                    descChiaveComp, MessaggiWSFormat.formattaUrnPartUnitaDoc(key)));
                } else {
                    rispostaControlli.setCodErr(MessaggiWSBundle.SUBCOMP_006_005);
                    rispostaControlli
                            .setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.SUBCOMP_006_005,
                                    descChiaveComp, MessaggiWSFormat.formattaUrnPartUnitaDoc(key)));
                }
                return rispostaControlli;
                ...
                if (tComp == TipologieComponente.COMPONENTE) {
                    ...
                    rispostaControlli
                            .setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.COMP_008_001,
                                    descChiaveComp, MessaggiWSFormat.formattaUrnPartUnitaDoc(key)));
                } else {
                    rispostaControlli.setCodErr(MessaggiWSBundle.SUBCOMP_006_001);
                    rispostaControlli
                            .setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.SUBCOMP_006_001,
                                    descChiaveComp, MessaggiWSFormat.formattaUrnPartUnitaDoc(key)));
                }
                return rispostaControlli;
            } else {
                ...
                if (!tipoComp.equals(CostantiDB.TipoUsoComponente.CONVERTITORE)) {
                    if (tComp == TipologieComponente.COMPONENTE) {
                        ...
                        rispostaControlli.setDsErr(MessaggiWSBundle.getString(
                                MessaggiWSBundle.COMP_008_002, descChiaveComp,
                                MessaggiWSFormat.formattaUrnPartUnitaDoc(key)));
                    } else {
                        rispostaControlli.setCodErr(MessaggiWSBundle.SUBCOMP_006_002);
                        rispostaControlli.setDsErr(MessaggiWSBundle.getString(
                                MessaggiWSBundle.SUBCOMP_006_002, descChiaveComp,
                                MessaggiWSFormat.formattaUrnPartUnitaDoc(key)));
                    }
                    return rispostaControlli;
                }
                String tipoSupporto = aroCompDocs.get(0).getAroStrutDoc().getAroDoc()
                        .getAroUnitaDoc().getDecTipoUnitaDoc().getTiSaveFile();
                if (!tipoSupporto.equals(CostantiDB.TipoSalvataggioFile.BLOB.name())) {
                    if (tComp == TipologieComponente.COMPONENTE) {
                        // L'unitï¿½ documentaria del convertitore indicato dal riferimento deve
                        // essere
                        // salvata su BLOB
                        rispostaControlli.setCodErr(MessaggiWSBundle.COMP_008_004);
                        rispostaControlli.setDsErr(MessaggiWSBundle.getString(
                                MessaggiWSBundle.COMP_008_004, descChiaveComp,
                                MessaggiWSFormat.formattaUrnPartUnitaDoc(key)));
                    } else {
                        rispostaControlli.setCodErr(MessaggiWSBundle.SUBCOMP_006_004);
                        rispostaControlli.setDsErr(MessaggiWSBundle.getString(
                                MessaggiWSBundle.SUBCOMP_006_004, descChiaveComp,
                                MessaggiWSFormat.formattaUrnPartUnitaDoc(key)));
                    }
                    return rispostaControlli;
                }
                rispostaControlli
                        .setrLong(aroCompDocs.get(0).getDecFormatoFileDoc().getIdFormatoFileDoc());
                rispostaControlli.setrBoolean(true);
            }
        } catch (Exception e) {
            rispostaControlli.setCodErr(MessaggiWSBundle.ERR_666);
    ...
    public RispostaControlli checkFormatoFileVersato(String nomeFormatoFile, long idStrut,
            long idTipoCompDoc) {
        RispostaControlli rispostaControlli;
        rispostaControlli = new RispostaControlli();
        ...
        try {
            // ricavo le ud presenti in base ai parametri impostati
            String queryStr = "select ff " + "from DecFormatoFileDoc ff "
                    + "join ff.decFormatoFileAmmessos fAmmessi "
                    + "where UPPER(ff.nmFormatoFileDoc) = :nmFormatoFileDocIn "
                    + "and fammessi.decTipoCompDoc.idTipoCompDoc = :idTipoCompDocIn "
                    + "and ff.orgStrut.idStrut = :idStrutIn "
                    + " and ff.dtIstituz <= :dataDiOggiIn " + " and ff.dtSoppres > :dataDiOggiIn "; // da
            // notare
            // STRETTAMENTE
            // MAGGIORE
            // della
     ...
     */
    public RispostaControlli checkDocumentoInUd(long idUnitaDoc, String idDocumento,
            String descUd) {
        RispostaControlli rispostaControlli;
        rispostaControlli = new RispostaControlli();
        ...
        try {
            String queryStr = "select doc " + "from AroDoc doc "
            ...
            if (aroDocs == null || aroDocs.isEmpty()) {
                ...
                rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.DOC_008_001,
                        idDocumento, descUd));
            }
        } catch (Exception e) {
            rispostaControlli.setCodErr(MessaggiWSBundle.ERR_666);
    ...
    public RispostaControlli checkFormatoFileStandard(String nomeFormatoFile) {
        ...
        try {
            ...
            query.setParameter("nmFormatoFileStdIn",
                    nomeFormatoFile != null ? nomeFormatoFile.toUpperCase() : null);
    ...
    public RispostaControlli calcAndcheckCdKeyNormalized(long idRegistro, CSChiave key,
        ...
        try {
            ...
            if (rispostaControlli.getrLong() == 0/* esiste */) {
                ...
                rispostaControlli = this.calcAndcheckCdKeyNormalized(idRegistro, key,
    ...
    public RispostaControlli checkUniqueCdKeyNormalized(CSChiave chiave, long idRegistro,
            long idUnitaDoc, String cdKeyNormalized, Date dtInizioCalcoloNewUrn) {
        RispostaControlli rispostaControlli;
        rispostaControlli = new RispostaControlli();
        rispostaControlli.setrBoolean(false);
        ...
        try {
            ...
            if (rispostaControlli.getrLong() != -1) {
                ...
                if ((dtVersMax.before(dtInizioCalcoloNewUrn)
                        || dtVersMax.equals(dtInizioCalcoloNewUrn))
                    ...
                    if (rispostaControlli.getrLong() == 0 /* esiste chiave normalizzata */) {
                        ...
                        rispostaControlli
                                .setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.UD_005_005,
    ...
    public RispostaControlli getDtCalcInizioNuoviUrn() {
        ...
        try {
            ...
            Date dtInizioCalcNuoviUrn = dateFormat.parse(config
                    .getValoreParamApplicByApplic(ParametroApplDB.DATA_INIZIO_CALC_NUOVI_URN));
