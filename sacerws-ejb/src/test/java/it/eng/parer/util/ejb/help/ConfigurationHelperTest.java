...
public class ConfigurationHelperTest {
    ...
    public static Archive<?> createTestArchive() {
        return createEnterpriseArchive("configurationHelperTest", createSacerWSJavaArchive(Collections.emptyList(),
                ConfigurationHelper.class, ConfigurationHelperTest.class), createSacerLogJavaArchive());
    }
