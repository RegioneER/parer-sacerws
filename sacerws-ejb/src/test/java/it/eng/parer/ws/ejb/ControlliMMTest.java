...
@ArquillianTest
public class ControlliMMTest {

    @Deployment
    public static Archive<?> createTestArchive() {
        return createEnterpriseArchive(ControlliMMTest.class.getSimpleName(),
                createSacerWSJavaArchive(Arrays.asList(""), ControlliMMTest.class, ControlliMM.class),
    ...
    public void caricaRootPath() {
        for (ControlliMM.TipiRootPath tipoRootPath : ControlliMM.TipiRootPath.values()) {
            final RispostaControlli rispostaControlli = controlliMM.caricaRootPath("SACER_PREINGEST", tipoRootPath);
