...
public abstract class AbsVersamentoExt implements IVersamentoExt, IErroriMultipli {
    ...
    public ECErroriSecondariType produciEsitoErroriSec() {
        ...
        if (getModificatoriWSCalc().contains(Costanti.ModificatoriWS.TAG_LISTA_ERR_OUT) && numErrori > 1) {
            erroriUlteriori = new ECErroriSecondariType();
            for (VoceDiErrore tmpVdE : erroriTrovati) {
                if (tmpVdE.getCodiceEsito() == TipiEsitoErrore.NEGATIVO && !tmpVdE.isElementoPrincipale()) {
    ...
    public ECWarningSecondariType produciEsitoWarningSec() {
        ...
        if (getModificatoriWSCalc().contains(Costanti.ModificatoriWS.TAG_LISTA_ERR_OUT)
            ...
            for (VoceDiErrore tmpVdE : erroriTrovati) {
                if (tmpVdE.getCodiceEsito() == TipiEsitoErrore.WARNING && !tmpVdE.isElementoPrincipale()) {
    ...
    //
    // <editor-fold defaultstate="collapsed" desc="errori e warning ud - sono degli alias dei metodi generici">
    ...
    public void listErrAddWarningDoc(DocumentoVers documento, String descElemento, String errCode, Object... params) {
        this.addWarningDoc(documento, descElemento, errCode, MessaggiWSBundle.getString(errCode, params));
    }
    ...
    //
    public void listErrAddErrorDoc(DocumentoVers documento, String descElemento, String errCode, Object... params) {
        this.addErrorDoc(documento, descElemento, errCode, MessaggiWSBundle.getString(errCode, params));
    }
    ...
    public VoceDiErrore addWarningDoc(DocumentoVers documento, String descElemento, String errCode, String errMessage) {
        VoceDiErrore tmpErrore = new VoceDiErrore();
        tmpErrore.setSeverity(IRispostaWS.SeverityEnum.WARNING);
        tmpErrore.setCodiceEsito(TipiEsitoErrore.WARNING);
    ...
    public VoceDiErrore addErrorDoc(DocumentoVers documento, String descElemento, String errCode, String errMessage) {
        VoceDiErrore tmpErrore = new VoceDiErrore();
        tmpErrore.setSeverity(IRispostaWS.SeverityEnum.ERROR);
        tmpErrore.setCodiceEsito(TipiEsitoErrore.NEGATIVO);
        tmpErrore.setElementoResponsabile(VoceDiErrore.ResponsabilitaErrore.DOC);
