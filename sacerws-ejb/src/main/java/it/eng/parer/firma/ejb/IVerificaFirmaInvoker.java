...
public interface IVerificaFirmaInvoker {
     ...
     * @param sottoComponentiFirma         sottocomponente versato di tipo "FIRMA"
     * @param sottoComponentiMarca         sottocomponente versato di tipo "MARCA"
     * @param controlliAbilitati           controlli abilitati (e.g. abilita controllo CRL, etc.)
     * @param dataVersamento               data versamento
     * @param verificaAllaDataDiFirma      flag 1/0 (true/false) per abilitare o meno la verifica
     *                                     alla data di firma
     * @param uuid                         UUID
     * @param skipDocumentSignVerification flag 1/0 (true/false) per abilitare o meno il salto della
     *                                     verifica della firma del documento utilizzato per caso
     *                                     particolari in cui si vuole ottenere solo il mimetype del
     *                                     documento
     * @param versamento                   astrazione con metadati di versamento
     *
     * @return wrapper compilato con risposta da microservizio
     *
     * @throws VerificaFirmaWrapperResNotFoundException eccezione generica
     * @throws VerificaFirmaConnectionException         eccezione dovuta a mancanza di ristosta
     *                                                  dell'endpoint
     * @throws VerificaFirmaWrapperGenericException     eccezione generica durante wrapping riposta
     *                                                  da microservizio
