...
public interface IControlliWsMultipli {
    ...
    // NEGATIVO
    void addEsitoControlloOnSistema(ControlloWSResp ctlrTypeWS, String errCode, String errMessage, Object... params);

    default void addEsitoControlloOnSistemaBundle(ControlloWSResp ctlrTypeWS, String errCode, Object... params) {
    ...
    default void addEsitoControlloOnGeneraliBundle(ControlloWSResp ctlrTypeWS, IRispostaWS.SeverityEnum severity,
            VoceDiErrore.TipiEsitoErrore esito, String errCode, Object... params) {
        addEsitoControlloOnGenerali(ctlrTypeWS, severity, esito, errCode, null, params);
    }

    // NEGATIVO/WARNING
    void addEsitoControlloOnFallitiUlteriori(ControlloWSResp ctlrTypeWS, IRispostaWS.SeverityEnum severity,
            VoceDiErrore.TipiEsitoErrore esito, String errCode, String errMessage, Object... params);

    // NEGATIVO/WARNING
    void addEsitoControlloOnControlliUnitaDocumentaria(ControlloWSResp ctlrTypeWS, IRispostaWS.SeverityEnum severity,
            VoceDiErrore.TipiEsitoErrore esito, String errCode, String errMessage, Object... params);

    default void addEsitoControlloOnControlliUnitaDocumentariaBundle(ControlloWSResp ctlrTypeWS,
            IRispostaWS.SeverityEnum severity, VoceDiErrore.TipiEsitoErrore esito, String errCode, Object... params) {
        addEsitoControlloOnControlliUnitaDocumentaria(ctlrTypeWS, severity, esito, errCode, null, params);
    }

    // NEGATIVO/WARNING
    void addEsitoControlloOnControlliDocPrincipale(ControlloWSResp ctlrTypeWS, IRispostaWS.SeverityEnum severity,
    ...
    default void addEsitoControlloOnControlliDocPrincipaleBundle(ControlloWSResp ctlrTypeWS,
            IRispostaWS.SeverityEnum severity, VoceDiErrore.TipiEsitoErrore esito, String idDocumento, String errCode,
            Object... params) {
        addEsitoControlloOnControlliDocPrincipale(ctlrTypeWS, severity, esito, idDocumento, errCode, null, params);
    }

    // NEGATIVO/WARNING
    void addEsitoControlloOnControlliAllegati(ControlloWSResp ctlrTypeWS, IRispostaWS.SeverityEnum severity,
            VoceDiErrore.TipiEsitoErrore esito, String idDocumento, String errCode, String errMessage,
            Object... params);
    ...
    default void addEsitoControlloOnControlliAllegatiBundle(ControlloWSResp ctlrTypeWS,
            IRispostaWS.SeverityEnum severity, VoceDiErrore.TipiEsitoErrore esito, String idDocumento, String errCode,
            Object... params) {
        addEsitoControlloOnControlliAllegati(ctlrTypeWS, severity, esito, idDocumento, errCode, null, params);
    }

    // NEGATIVO/WARNING
    void addEsitoControlloOnControlliAnnessi(ControlloWSResp ctlrTypeWS, IRispostaWS.SeverityEnum severity,
            VoceDiErrore.TipiEsitoErrore esito, String idDocumento, String errCode, String errMessage,
            Object... params);
    ...
    default void addEsitoControlloOnControlliAnnessiBundle(ControlloWSResp ctlrTypeWS,
            IRispostaWS.SeverityEnum severity, VoceDiErrore.TipiEsitoErrore esito, String idDocumento, String errCode,
            Object... params) {
        addEsitoControlloOnControlliAnnessi(ctlrTypeWS, severity, esito, idDocumento, errCode, null, params);
    }

    // NEGATIVO/WARNING
    void addEsitoControlloOnControlliAnnotazioni(ControlloWSResp ctlrTypeWS, IRispostaWS.SeverityEnum severity,
            VoceDiErrore.TipiEsitoErrore esito, String idDocumento, String errCode, String errMessage,
            Object... params);
    ...
    default void addEsitoControlloOnControlliAnnotazioniBundle(ControlloWSResp ctlrTypeWS,
            IRispostaWS.SeverityEnum severity, VoceDiErrore.TipiEsitoErrore esito, String idDocumento, String errCode,
            Object... params) {
        addEsitoControlloOnControlliAnnotazioni(ctlrTypeWS, severity, esito, idDocumento, errCode, null, params);
    }
    ...
    default void addEsitoControlloOnControlliComponentiDocPrincipaleBundle(ControlloWSResp ctlrTypeWS,
            IRispostaWS.SeverityEnum severity, VoceDiErrore.TipiEsitoErrore esito, String idComponente, String errCode,
            Object... params) {
        addEsitoControlloOnControlliComponentiDocPrincipale(ctlrTypeWS, severity, esito, idComponente, errCode, null,
                params);
    }

    // NEGATIVO/WARNING
    void addEsitoControlloOnControlliComponentiAllegati(ControlloWSResp ctlrTypeWS, IRispostaWS.SeverityEnum severity,
            VoceDiErrore.TipiEsitoErrore esito, String idComponente, String errCode, String errMessage,
            Object... params);

    default void addEsitoControlloOnControlliComponentiAllegatiBundle(ControlloWSResp ctlrTypeWS,
            IRispostaWS.SeverityEnum severity, VoceDiErrore.TipiEsitoErrore esito, String idComponente, String errCode,
            Object... params) {
        addEsitoControlloOnControlliComponentiAllegati(ctlrTypeWS, severity, esito, idComponente, errCode, null,
                params);
    }

    // NEGATIVO/WARNING
    void addEsitoControlloOnControlliComponentiAnnessi(ControlloWSResp ctlrTypeWS, IRispostaWS.SeverityEnum severity,
            VoceDiErrore.TipiEsitoErrore esito, String idComponente, String errCode, String errMessage,
            Object... params);
    ...
    default void addEsitoControlloOnControlliComponentiAnnessiBundle(ControlloWSResp ctlrTypeWS,
            IRispostaWS.SeverityEnum severity, VoceDiErrore.TipiEsitoErrore esito, String idComponente, String errCode,
            Object... params) {
        addEsitoControlloOnControlliComponentiAnnessi(ctlrTypeWS, severity, esito, idComponente, errCode, null, params);
    }
    ...
    default void addEsitoControlloOnControlliComponentiAnnotazioniBundle(ControlloWSResp ctlrTypeWS,
            IRispostaWS.SeverityEnum severity, VoceDiErrore.TipiEsitoErrore esito, String idComponente, String errCode,
            Object... params) {
        addEsitoControlloOnControlliComponentiAnnotazioni(ctlrTypeWS, severity, esito, idComponente, errCode, null,
                params);
    }

    // NEGATIVO/WARNING
    void addEsitoControlloOnControlliCollegamento(ControlloWSResp ctlrTypeWS, IRispostaWS.SeverityEnum severity,
            VoceDiErrore.TipiEsitoErrore esito, CSChiave csChiave, String errCode, String errMessage, Object... params);

    default void addEsitoControlloOnControlliCollegamentoBundle(ControlloWSResp ctlrTypeWS,
            IRispostaWS.SeverityEnum severity, VoceDiErrore.TipiEsitoErrore esito, CSChiave csChiave, String errCode,
            Object... params) {
        addEsitoControlloOnControlliCollegamento(ctlrTypeWS, severity, esito, csChiave, errCode, null, params);
    }

    // NEGATIVO/WARNING
    void addControlloOnWarnings(ControlloWSResp ctlrTypeWS, String errCode, String errMessage, Object... params);

    default void addControlloOnWarningsBundle(ControlloWSResp ctlrTypeWS, String errCode, Object... params) {
    ...
    // utils
    default boolean allMatchEsitoControlli(List<ControlloEseguito> controlli, TipiEsitoErrore esito) {
        return !controlli.isEmpty() && controlli.stream().allMatch(e -> e.getEsito().equals(esito));
    }

    default boolean anyMatchEsitoControlli(List<ControlloEseguito> controlli, TipiEsitoErrore esito) {
        return !controlli.isEmpty() && controlli.stream().anyMatch(e -> e.getEsito().equals(esito));
    }

    default boolean allMatchEsitoControlliByCdFamiglia(List<ControlloEseguito> controlli, FamigliaControllo famiglia,
            TipiEsitoErrore esito) {
        return !controlli.isEmpty() && controlli.stream().filter(c -> c.getFamiglia().equals(famiglia))
                .allMatch(e -> e.getEsito().equals(esito));
    }

    default boolean anyMatchEsitoControlliByCdFamiglia(List<ControlloEseguito> controlli, FamigliaControllo famiglia,
            TipiEsitoErrore esito) {
        return !controlli.isEmpty() && controlli.stream().filter(c -> c.getFamiglia().equals(famiglia))
    ...
    default List<ControlloEseguito> sortControlli(Set<ControlloEseguito> controlli) {
        ...
        // per tipo famiglia
        Collections.sort(sortedList, (c1, c2) -> c1.getFamiglia().getNiOrd().compareTo(c2.getFamiglia().getNiOrd()));
    ...
    default ControlloEseguito buildControlloEseguito(Set<ControlloEseguito> controlli,
            IRispostaWS.SeverityEnum severity, VoceDiErrore.TipiEsitoErrore esito, ControlloWSResp ctlrTypeWS,
            String errCode, String errMessage, Object... params) {
        ...
        if (StringUtils.isNotBlank(errCode)) {
            VoceDiErrore voceDiErrore = makeAddVoceDiErrore(severity, esito, errCode, errMessage, params);
    ...
    default VoceDiErrore makeAddVoceDiErrore(IRispostaWS.SeverityEnum severity, VoceDiErrore.TipiEsitoErrore esito,
            String errCode, String errMessage, Object... params) {
        // errore registrato
        ...
        if (StringUtils.isNotBlank(errMessage)) {
            ...
            tmpErrore.setErrorMessage(params.length > 0 ? MessaggiWSBundle.getString(errCode, params)
    ...
    default ControlloEseguito findOrCreateControlloEseguito(Set<ControlloEseguito> list, ControlloWSResp ctlrTypeWS) {
        ...
        List<ControlloEseguito> cftFiltered = list.stream()
                .filter(c -> c.getCdControllo().equals(ctlrTypeWS.getCdControllo())).collect(Collectors.toList());
        if (cftFiltered != null && !cftFiltered.isEmpty()) {
            ...
            controllo
                    .setFamiglia(ControlloEseguito.FamigliaControllo.valueOf(ctlrTypeWS.getCdFamiglia().toUpperCase()));
    ...
    default boolean verificaErrorePrinc(RispostaWSUpdVers rispostaWs, ControlloEseguito controllo,
            VoceDiErrore errore) {
        return rispostaWs.getControlloWs().getCdControllo().equalsIgnoreCase(controllo.getCdControllo())
