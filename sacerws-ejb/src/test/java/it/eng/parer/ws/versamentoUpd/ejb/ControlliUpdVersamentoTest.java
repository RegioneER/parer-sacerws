...
public class ControlliUpdVersamentoTest {
    ...
    public static Archive<?> createTestArchive() {
        return createEnterpriseArchive(ControlliUpdVersamentoTest.class.getSimpleName(),
                createSacerWSJavaArchive(
                        Arrays.asList("it.eng.parer.ws.versamentoUpd.ext", "it.eng.parer.ws.xml.versUpdReq"),
                        ControlliUpdVersamentoTest.class, ControlliUpdVersamento.class, ControlliSemantici.class),
    ...
    public void checkUltimoSIPWithHashBinary() {
        final RispostaControlli rispostaControlli = controlliUpdVersamento.checkUltimoSIPWithHashBinary("descKey", 0l,
                "sipxml");
    ...
    public void checkTipoUDRegIamUserOrganizzazione() {
        final RispostaControlli rispostaControlli = controlliUpdVersamento
                .checkTipoUDRegIamUserOrganizzazione(mockCsChiave(), "descTipologiaUnitaDocumentaria", 0l, 0l, 0l, 0l);
        assertNoErr(rispostaControlli);
    }

    @Test
    public void getUpdFlagsFromTipoUDOrgStrut() {
        RispostaControlli rispostaControlli = controlliUpdVersamento.getUpdFlagsFromTipoUDOrgStrut(0l, false);
        assertNoErr(rispostaControlli);
    ...
    public void checkIdDocumentoInUD() {
        final RispostaControlli rispostaControlli = controlliUpdVersamento.checkIdDocumentoInUD(0l, "idDoc",
                "descChiaveDoc");
        assertNoErr(rispostaControlli);
    }
    ...
    public void checkIdComponenteInDoc() {
        final RispostaControlli rispostaControlli = controlliUpdVersamento.checkIdComponenteInDoc(0l, 0,
                "descChiaveComp");
        assertNoErr(rispostaControlli);
    }
    ...
    public void checkAroStrutDocAndTipo() {
        final RispostaControlli rispostaControlli = controlliUpdVersamento.checkAroStrutDocAndTipo(0L);
        assertNoErr(rispostaControlli);
    }
    ...
    public void checkFascicoliSecondari() {
        ...
        versamento.getVersamento().getUnitaDocumentaria().getProfiloArchivistico()
                .setFascicoliSecondari(new AggiornamentoProfiloArchivisticoType.FascicoliSecondari());
        versamento.getVersamento().getUnitaDocumentaria().getProfiloArchivistico().getFascicoliSecondari();
        final RispostaControlli rispostaControlli = controlliUpdVersamento.checkFascicoliSecondari(versamento);
        assertNoErr(rispostaControlli);
    }
